...
import { e as g, f as F, a as I, b as z } from "./defaultLocale-C4B-KCzX.js";
function M(n, r) {
...
function X(n, r) {
  return Math.max(
    0,
    Math.max(-8, Math.min(8, Math.floor(g(r) / 3))) * 3 - g(Math.abs(n)),
  );
}
function Y(n, r) {
  return (
...
function rn(n, r, t) {
  var e = Math.min(n.length, r.length) - 1,
    ...
    a = -1;
  for (
    n[e] < n[0] && ((n = n.slice().reverse()), (r = r.slice().reverse()));
    ++a < e;
  )
...
function an(n, r, t, e) {
  ...
  switch (((e = F(e ?? ",f")), e.type)) {
    case "s": {
      ...
      return (
        e.precision == null && !isNaN((f = X(u, a))) && (e.precision = f),
        I(e, a)
      );
    }
    case "":
...
function on(n) {
  ...
  return (
    (n.ticks = function (t) {
      var e = r();
      return L(e[0], e[e.length - 1], t ?? 10);
    }),
...
export { en as a, R as b, un as c, fn as l, O as t };
