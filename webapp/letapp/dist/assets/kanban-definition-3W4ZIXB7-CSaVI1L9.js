...
import { g as Ne } from "./chunk-FMBD7UC4-VajrL-yk.js";
...
var $ = (function () {
  var e = o(function (O, i, n, r) {
    ...
    T = {
      ...
      performAction: o(function (i, n, r, a, h, t, M) {
        var c = t.length - 1;
        switch (h) {
          case 6:
          case 7:
          ...
          switch (x[0]) {
            ...
            case 2:
              ...
              (C &&
                ...
                h.push(j.$),
                t.push(j._$),
                (oe = M[r[r.length - 2]][r[r.length - 1]]),
                r.push(oe));
              break;
            case 3:
              return !0;
...
var xe = $,
  ...
  Oe = o((e, u, p, s, d) => {
    const E = U();
    let m = E.mindmap?.padding ?? X.mindmap.padding;
    switch (s) {
      case f.ROUNDED_RECT:
      case f.RECT:
      case f.HEXAGON:
    ...
    const l = {
      ...
      level: e,
      label: F(p, E),
      width: E.mindmap?.maxNodeWidth ?? X.mindmap.maxNodeWidth,
      padding: m,
      isGroup: !1,
    };
    if (d !== void 0) {
...
` +
  ...
  we = o((e) => {
    ...
    const u = U(),
      p = v[v.length - 1];
    (e.icon && (p.icon = F(e.icon, u)),
      e.class && (p.cssClasses = F(e.class, u)));
  }, "decorateNode"),
  Ae = o((e) => {
    switch (e) {
      case f.DEFAULT:
...
` + e,
    ...
    const I = l.append("g");
    I.attr("class", "items");
    const g = E.nodes.filter((b) => b.isGroup);
    let w = 0;
    const _ = 10,
      G = [];
    let N = 25;
    ...
    for (const b of g) {
      ...
      const L = m?.kanban?.sectionWidth || 200,
        H = (-L * 3) / 2 + N;
      let T = H;
      const Y = E.nodes.filter((i) => i.parentId === b.id);
      for (const i of Y) {
        if (i.isGroup)
          throw new Error(
        ...
        ((i.y = T + r.height / 2),
          await be(i),
          (T = i.y + r.height / 2 + _ / 2));
      }
      const B = A.cluster.select("rect"),
        O = Math.max(T - H + 3 * _, 50) + (N - 25);
      B.attr("height", O);
    }
    _e(
      void 0,
      l,
      m.mindmap?.padding ?? X.kanban.padding,
      m.mindmap?.useMaxWidth ?? X.kanban.useMaxWidth,
    );
  }, "draw"),
  je = { draw: Be },
  Fe = o((e) => {
...
`,
  ...
  He = Ge,
  Qe = { db: Ve, renderer: je, parser: xe, styles: He };
