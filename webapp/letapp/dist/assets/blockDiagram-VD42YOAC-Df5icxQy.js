import { g as oe } from "./chunk-FMBD7UC4-VajrL-yk.js";
import {
  _ as d,
  G as rt,
  d as O,
...
import { e as Le } from "./vendor-naive-Co-etydz.js";
import { G as Se } from "./graph-DGE5ET1D.js";
import { c as ke } from "./channel-CXGY4jjC.js";
      ...
      performAction: d(function (y, g, f, m, E, h, W) {
        ...
        switch (E) {
          ...
          case 15:
            (m
              .getLogger()
              .debug("Rule: LABEL link: ", h[p - 3], h[p - 1], h[p]),
          ...
          case 24:
            (m
              .getLogger()
              .debug("Rule: nodeStatement (abc88 node size) ", h[p - 1], h[p]),
              (this.$ = {
                id: h[p - 1].id,
                label: h[p - 1].label,
          ...
          case 27:
            (m
              .getLogger()
              .debug("Rule: id-block statement : ", h[p - 2], h[p - 1]),
              m.generateId(),
              (this.$ = {
                ...h[p - 2],
                type: "composite",
          ...
          case 33:
            (m
              .getLogger()
              .debug("Rule: nodeShapeNLabel: ", h[p - 2], h[p - 1], h[p]),
...
` +
        ...
        pastInput: d(function () {
          var y = this.matched.substr(
            0,
            this.matched.length - this.match.length,
          );
          return (
            (y.length > 20 ? "..." : "") + y.substr(-20).replace(/\n/g, "")
          );
        }, "pastInput"),
...
var sr = d((e) => {
  ...
  for (const i of e.children) {
    ...
    (L.debug(
      ...
      i.type !== "space" &&
        (l > t && (t = l / (e.widthInColumns ?? 1)), s > a && (a = s)));
  }
  ...
  if (e.children?.length > 0) {
    ...
    for (const b of e.children)
      b.size &&
        ...
        (b.size.width =
          l * (b.widthInColumns ?? 1) + C * ((b.widthInColumns ?? 1) - 1)),
        (b.size.height = s),
        (b.size.x = 0),
        (b.size.y = 0),
        L.debug(
...
function Et(e, t) {
  ...
  const a = e.columns ?? -1;
  if (
    (L.debug("layoutBlocks columns abc95", e.id, "=>", a, e),
    ...
    for (const c of e.children) {
      ...
      (a > 0 && (S = Math.min(S, a - (s % a))),
        (s += S),
        L.debug("abc88 columnsPos", c, s));
    }
  }
  L.debug(
  ...
  if (e.children)
    for (const s of e.children)
      ({
        ...
        maxX: i,
        maxY: l,
      } = _t(s, { minX: t, minY: a, maxX: i, maxY: l }));
...
var or = d((e, t) => {
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
    ...
    if (Math.abs(l - t.y) * r > Math.abs(i - t.x) * c) {
      ...
      return (
        L.debug(`sides calc abc89, Q ${u}, q ${x}, R ${o}, r ${n}`, {
          _x: w,
          _y: b,
        }),
        n === 0 && ((w = t.x), (b = t.y)),
...
function $t(e, t, a) {
  ...
  for (
    var c = i - e.width / 2 - r, u = l - e.height / 2 - n, o = 0;
    o < t.length;
    o++
  ) {
    var x = t[o],
...
var Ar = d(async (e, t) => {
    ...
    const b = r
      .node()
      .appendChild(await K(x.join ? x.join("<br/>") : x, t.labelStyle, !0, !0));
    if (j(R().flowchart.htmlLabels)) {
  ...
  Fr = d(async (e, t) => {
    ...
    return (
      ...
      (t.intersect = function (r) {
        return (
          L.info("Circle intersect", t, i.width / 2 + l, r),
          N.circle(t, i.width / 2 + l, r)
        );
      }),
      a
    );
  ...
  Kr = d(async (e, t) => {
    ...
    (t.classData.members.forEach(async (E) => {
      ...
      const p = w
        .node()
        .appendChild(
          await K(W, h.cssStyle ? h.cssStyle : t.labelStyle, !0, !0),
        );
      let I = p.getBBox();
      if (j(R().flowchart.htmlLabels)) {
...
var Ur = d(function (e, t) {
  ...
  jr = d(async function (e, t, a, i) {
    ...
    l === "sandbox" && (n = O("#i" + t));
    const c =
        l === "sandbox" ? O(n.nodes()[0].contentDocument.body) : O("body"),
  ...
  ia = { parser: ve, db: Ke, renderer: Vr, styles: Ue };
