...
import { l as ee } from "./linear-BeNOPYj5.js";
    ...
    kt = {
      ...
      parse: o(function (r) {
        ...
        for (var Ft in this.yy)
          Object.prototype.hasOwnProperty.call(this.yy, Ft) &&
            (Y.yy[Ft] = this.yy[Ft]);
        (E.setInput(r, Y.yy),
          (Y.yy.lexer = E),
          (Y.yy.parser = this),
        ...
        function $t() {
          ...
          return (
            (B = c.pop() || E.lex() || Jt),
            typeof B != "number" &&
              (B instanceof Array && ((c = B), (B = c.pop())),
              (B = l.symbols_[B] || B)),
            B
          );
        }
          ...
          switch (N[0]) {
            ...
            case 2:
              if (
                ...
                (vt = this.performAction.apply(
                  rt,
                  [s, Zt, yt, Y.yy, N[1], S, e].concat(qe),
                )),
                typeof vt < "u")
              )
                return vt;
      ...
      var M = {
        ...
        unput: o(function (r) {
          ...
          return (
            ...
            this.options.ranges &&
              (this.yylloc.range = [S[0], S[0] + this.yyleng - l]),
...
` +
        ...
        next: o(function () {
          ...
          for (var S = this._currentRules(), e = 0; e < S.length; e++)
            if (
              ((x = this._input.match(this.rules[S[e]])),
              x && (!l || x[0].length > l[0].length))
            ) {
...
var De = Et,
  ...
  ze =
    ((ot = class {
      ...
      setConfig(n) {
        (bt.trace("setConfig called with: ", n),
...
` + t,
    ...
    a === "sandbox" && (A = Lt("#i" + n));
    const T = (
        a === "sandbox" ? Lt(A.nodes()[0].contentDocument.body) : Lt("body")
      ).select(`[id="${n}"]`),
  ...
  Re = { draw: Be },
  Ke = { parser: De, db: we, renderer: Re, styles: o(() => "", "styles") };
