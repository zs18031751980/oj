import { g as ze } from "./chunk-55IACEB6-DFsD1jDV.js";
import { s as Ge } from "./chunk-QN33PNHL-Bp-R7uq3.js";
import {
  _ as f,
  b as Xe,
  a as Je,
...
var Ae = (function () {
  var e = f(function (P, i, n, c) {
    ...
    Se = {
      ...
      performAction: f(function (i, n, c, s, p, t, pe) {
        var a = t.length - 1;
        switch (p) {
          case 4:
          ...
          case 21:
            ...
            break;
          case 22:
            (s.addRequirement(t[a - 5], t[a - 6]),
              s.setClass([t[a - 5]], t[a - 3]));
            break;
          case 23:
            s.setNewReqId(t[a - 2]);
            break;
      ...
      table: [
        ...
        e(E, [2, 19]),
        e(E, [2, 20]),
        { 30: 60, 33: 62, 75: $, 89: d, 90: R },
        { 30: 63, 33: 62, 75: $, 89: d, 90: R },
        { 30: 64, 33: 62, 75: $, 89: d, 90: R },
        e(X, [2, 29]),
        e(X, [2, 30]),
        e(X, [2, 31]),
        e(X, [2, 32]),
        ...
        { 30: 94, 33: 62, 75: $, 76: U, 89: d, 90: R },
        { 5: [1, 95] },
        { 30: 96, 33: 62, 75: $, 89: d, 90: R },
        { 5: [1, 97] },
        { 30: 98, 33: 62, 75: $, 89: d, 90: R },
        { 63: [1, 99] },
        e(Y, [2, 50]),
        e(Y, [2, 51]),
        e(Y, [2, 52]),
      ...
      parse: f(function (i) {
        ...
        function Ue() {
          ...
          return (
            (I = s.pop() || g.lex() || $e),
            typeof I != "number" &&
              (I instanceof Array && ((s = I), (I = s.pop())),
              (I = n.symbols_[I] || I)),
            I
          );
        }
            ...
            case 2:
              if (
                ...
                (Te = this.performAction.apply(
                  J,
                  [a, Pe, ye, z.yy, k[1], p, t].concat(Ke),
                )),
                typeof Te < "u")
              )
                return Te;
              (F &&
                ...
                p.push(J.$),
                t.push(J._$),
                (Ye = pe[c[c.length - 2]][c[c.length - 1]]),
                c.push(Ye));
              break;
            case 3:
              return !0;
...
` +
        ...
        next: f(function () {
          ...
          for (var p = this._currentRules(), t = 0; t < p.length; t++)
            if (
              ...
              if (((n = c), (s = t), this.options.backtrack_lexer)) {
                if (((i = this.test_match(c, p[t])), i !== !1)) return i;
                if (this._backtrack) {
                  n = !1;
                  continue;
                } else return !1;
          ...
          return n
            ? ((i = this.test_match(n, p[s])), i !== !1 ? i : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        topState: f(function (n) {
          return (
            (n = this.conditionStack.length - 1 - Math.abs(n || 0)),
            n >= 0 ? this.conditionStack[n] : "INITIAL"
          );
        }, "topState"),
        pushState: f(function (n) {
          this.begin(n);
        }, "pushState"),
        ...
        performAction: f(function (n, c, s, p) {
          switch (s) {
            case 0:
              return "title";
            case 1:
    ...
    ((Z = class {
      constructor() {
        ((this.relations = []),
          ...
          (this.getConfig = f(() => Ne().requirement, "getConfig")),
          this.clear(),
      ...
      setNewReqId(l) {
        this.latestRequirement !== void 0 &&
          (this.latestRequirement.requirementId = l);
      }
      setNewReqText(l) {
      ...
      setNewReqVerifyMethod(l) {
        this.latestRequirement !== void 0 &&
          (this.latestRequirement.verifyMethod = l);
      }
      addElement(l) {
        return (
          this.elements.has(l) ||
      ...
      defineClass(l, u) {
        for (const h of l) {
          ...
          (r === void 0 &&
            ((r = { id: h, styles: [], textStyles: [] }),
            this.classes.set(h, r)),
            u &&
            ...
            this.requirements.forEach((o) => {
              o.classes.includes(h) &&
                o.cssStyles.push(...u.flatMap((m) => m.split(",")));
            }),
      ...
      getData() {
        ...
        for (const r of this.relations) {
          let o = 0;
          const m = r.type === this.Relationships.CONTAINS,
            y = {
              id: `${r.src}-${r.dst}-${o}`,
              start:
                this.requirements.get(r.src)?.name ??
                this.elements.get(r.src)?.name,
              end:
                this.requirements.get(r.dst)?.name ??
                this.elements.get(r.dst)?.name,
              label: `&lt;&lt;${r.type}&gt;&gt;`,
...
`,
  ...
  Be = {};
rt(Be, { draw: () => ft });
var ft = f(async function (e, l, u, h) {
    (qe.info("REF0:"), qe.info("Drawing requirement diagram (unified)", l));
    const { securityLevel: r, state: o, layout: m } = Ne(),
      y = h.db.getData(),
      _ = ze(l, r);
    ((y.type = h.type),
      (y.layoutAlgorithm = nt(m)),
