import { _ as V, l as $, d as lt } from "./MarkdownComponent-Dj4guaHi.js";
import { c as tt } from "./cytoscape.esm-BnkdMOzK.js";
import { g as gt } from "./vendor-markdown-HlADSkmp.js";
          ...
          return (function (N) {
            ...
            function (N, I, L) {
              ...
              ((i.prototype.getSource = function () {
                ...
                (i.prototype.getOtherEndInGraph = function (g, n) {
                  for (
                    var d = this.getOtherEnd(g),
                      r = n.getGraphManager().getRoot();
                    ;
                  ) {
                      ...
                      (this.labelWidth > h &&
                        ...
                        this.labelHeight > a &&
                          (this.labelPos == "center"
                            ...
                            : this.labelPos == "top" &&
                              (this.rect.y -= this.labelHeight - a),
              ...
              ((h.prototype.getNodes = function () {
                ...
                (h.prototype.remove = function (p) {
                  ...
                  if (p instanceof l) {
                    ...
                    for (
                      var D = v.edges.slice(), u, T = D.length, y = 0;
                      y < T;
                      y++
                    )
                      ((u = D[y]),
                ...
                (h.prototype.calcEstimatedSize = function () {
                  for (
                    var p = 0, v = this.nodes, D = v.length, u = 0;
                    u < D;
                    u++
                  ) {
                    var T = v[u];
              ...
              ((t.prototype.addRoot = function () {
                ...
                (t.prototype.remove = function (i) {
                  if (i instanceof o) {
                    ...
                    if (!(
                      l == this.rootGraph ||
                      (l.parent != null && l.parent.graphManager == this)
                    ))
                    ...
                    if (
                      ...
                      !(
                        n.source.owner != null &&
                        n.source.owner.getGraphManager() != null
                      ))
                    )
                ...
                (t.prototype.getAllNodes = function () {
                  if (this.allNodes == null) {
                    for (
                      var i = [], l = this.getGraphs(), g = l.length, n = 0;
                      n < g;
                      n++
                    )
            ...
            function (N, I, L) {
              ...
              ((e.MAX_ITERATIONS = 2500),
                ...
                (e.MAX_NODE_DISPLACEMENT =
                  e.MAX_NODE_DISPLACEMENT_INCREMENTAL * 3),
            ...
            function (N, I, L) {
              ...
              ((e.calcSeparationAmount = function (t, i, l, g) {
                ...
                (this.decideDirectionsForOverlappingNodes(t, i, n),
                  (l[0] =
                    Math.min(t.getRight(), i.getRight()) - Math.max(t.x, i.x)),
                  (l[1] =
                    Math.min(t.getBottom(), i.getBottom()) -
                    Math.max(t.y, i.y)),
                  t.getX() <= i.getX() && t.getRight() >= i.getRight()
                    ? (l[0] += Math.min(
                        i.getX() - t.getX(),
                        t.getRight() - i.getRight(),
                      ))
                    : i.getX() <= t.getX() &&
                ...
                var d = Math.abs(
                  (i.getCenterY() - t.getCenterY()) /
                    (i.getCenterX() - t.getCenterX()),
                );
                i.getCenterY() === t.getCenterY() &&
                  i.getCenterX() === t.getCenterX() &&
                  (d = 1);
              ...
              ((e.lastID = 0),
                (e.createID = function (t) {
                  return e.isPrimitive(t)
                    ? t
                    : (t.uniqueID != null ||
                        ((t.uniqueID = e.getString()), e.lastID++),
                      t.uniqueID);
                }),
              ...
              function h(a) {
                (r.call(this),
                  ...
                  (this.uniformLeafNodeSizes =
                    e.DEFAULT_UNIFORM_LEAF_NODE_SIZES),
              ...
              ((h.RANDOM_SEED = 1),
                ...
                (h.prototype.update2 = function () {
                  if (
                    ...
                    for (
                      var a = this.graphManager.getAllEdges(), p = 0;
                      p < a.length;
                      p++
                    )
                      a[p];
                    for (
                      var v = this.graphManager.getRoot().getNodes(), p = 0;
                      p < v.length;
                      p++
                    )
                      v[p];
                ...
                (h.prototype.initParameters = function () {
                  (this.isSubLayout ||
                    ...
                    (this.incremental = e.DEFAULT_INCREMENTAL),
                    (this.createBendsAsNeeded =
                      e.DEFAULT_CREATE_BENDS_AS_NEEDED),
                    (this.uniformLeafNodeSizes =
                      e.DEFAULT_UNIFORM_LEAF_NODE_SIZES)),
                    this.animationDuringLayout &&
                ...
                (h.prototype.getFlatForest = function () {
                  for (
                    var a = [],
                      p = !0,
                      v = this.graphManager.getRoot().getNodes(),
                      D = !0,
                      u = 0;
                    u < v.length;
                    u++
                ...
                (h.prototype.createBendpointsFromDummyNodes = function () {
                  ...
                  for (var p = 0; p < a.length; p++) {
                    ...
                    if (v.bendpoints.length > 0) {
                      for (
                        var D = this.edgeToDummyNodes.get(v), u = 0;
                        u < D.length;
                        u++
                      ) {
                        var T = D[u],
                ...
                (e.prototype.transformX = function (t) {
                  ...
                  return (
                    l != 0 &&
                      (i =
                        this.ldeviceOrgX +
                        ((t - this.lworldOrgX) * this.ldeviceExtX) / l),
                    i
                  );
                }),
                (e.prototype.transformY = function (t) {
                  ...
                  return (
                    l != 0 &&
                      (i =
                        this.ldeviceOrgY +
                        ((t - this.lworldOrgY) * this.ldeviceExtY) / l),
                    i
                  );
                }),
                (e.prototype.inverseTransformX = function (t) {
                  ...
                  return (
                    l != 0 &&
                      (i =
                        this.lworldOrgX +
                        ((t - this.ldeviceOrgX) * this.lworldExtX) / l),
                    i
                  );
                }),
                (e.prototype.inverseTransformY = function (t) {
                  ...
                  return (
                    l != 0 &&
                      (i =
                        this.lworldOrgY +
                        ((t - this.ldeviceOrgY) * this.lworldExtY) / l),
                    i
                  );
                }),
              ...
              function n() {
                (e.call(this),
                  ...
                  (this.compoundGravityConstant =
                    t.DEFAULT_COMPOUND_GRAVITY_STRENGTH),
              ...
              ((n.prototype.initParameters = function () {
                (e.prototype.initParameters.call(this, arguments),
                  ...
                  (this.useFRGridVariant =
                    t.DEFAULT_USE_SMART_REPULSION_RANGE_CALCULATION),
                  (this.grid = []));
              }),
                  ...
                  (this.incremental
                    ? (r > t.ADAPTATION_LOWER_NODE_LIMIT &&
                        (this.coolingFactor = Math.max(
                          ...
                          this.coolingFactor -
                            ((r - t.ADAPTATION_LOWER_NODE_LIMIT) /
                              (t.ADAPTATION_UPPER_NODE_LIMIT -
                                t.ADAPTATION_LOWER_NODE_LIMIT)) *
                              this.coolingFactor *
                              (1 - t.COOLING_ADAPTATION_FACTOR),
                        )),
                      (this.maxNodeDisplacement =
                        t.MAX_NODE_DISPLACEMENT_INCREMENTAL))
                    : (r > t.ADAPTATION_LOWER_NODE_LIMIT
                        ? (this.coolingFactor = Math.max(
                  ...
                  if (a.intersects(p)) {
                    ...
                    h.getChild() == null
                      ...
                      : (l.getIntersection(a, p, D),
                        (u = D[2] - D[0]),
                        (T = D[3] - D[1])),
                      Math.abs(u) < t.MIN_REPULSION_DIST &&
                        (u = g.sign(u) * t.MIN_REPULSION_DIST),
                      Math.abs(T) < t.MIN_REPULSION_DIST &&
                ...
                (n.prototype.calcNoOfChildrenForAllNodes = function () {
                  for (
                    var r, h = this.graphManager.getAllNodes(), a = 0;
                    a < h.length;
                    a++
                  )
                ...
                (n.prototype.calcGrid = function (r) {
                  ...
                  for (var p = new Array(h), v = 0; v < h; v++)
                    p[v] = new Array(a);
                  for (var v = 0; v < h; v++)
                    for (var D = 0; D < a; D++) p[v][D] = new Array();
                  return p;
                }),
                (n.prototype.addNodeToGrid = function (r, h, a) {
                  var p = 0,
                    ...
                    u = 0;
                  ((p = parseInt(
                    Math.floor((r.getRect().x - h) / this.repulsionRange),
                  )),
                    (v = parseInt(
                      Math.floor(
                        (r.getRect().width + r.getRect().x - h) /
                          this.repulsionRange,
                      ),
                    )),
                    (D = parseInt(
                      Math.floor((r.getRect().y - a) / this.repulsionRange),
                    )),
                    (u = parseInt(
                      Math.floor(
                        (r.getRect().height + r.getRect().y - a) /
                          this.repulsionRange,
                      ),
                    )));
                  for (var T = p; T <= v; T++)
                ...
                (n.prototype.calculateRepulsionForceOfANode = function (
                  r,
                  h,
                  a,
                  p,
                  ...
                  if (
                    ...
                    for (
                      var D, u = this.grid, T = r.startX - 1;
                      T < r.finishX + 2;
                      T++
                    )
            ...
            function (N, I, L) {
              ...
              ((e.prototype.add = function (t) {
                ...
                (e.prototype.addAllTo = function (t) {
                  for (
                    var i = Object.keys(this.set), l = i.length, g = 0;
                    g < l;
                    g++
                  )
                    t.push(this.set[i[g]]);
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        for (var n = 1; n < this.iMax; n++)
                          ((this.grid[n][0] =
                            this.grid[n - 1][0] + this.gap_penalty),
            ...
            function (I, L, o) {
              ...
              ((i.prototype.move = function () {
                ...
                ((this.displacementX =
                  ...
                  Math.abs(this.displacementX) >
                    ...
                    (this.displacementX =
                      ...
                      t.sign(this.displacementX)),
                  Math.abs(this.displacementY) >
                    g.coolingFactor * g.maxNodeDisplacement &&
                    (this.displacementY =
                      g.coolingFactor *
                      g.maxNodeDisplacement *
                      t.sign(this.displacementY)),
                  this.child == null
                ...
                (i.prototype.propogateDisplacementToChildren = function (g, n) {
                  for (
                    var d = this.getChild().getNodes(), r, h = 0;
                    h < d.length;
                    h++
                  )
                    ((r = d[h]),
            ...
            function (I, L, o) {
              ...
              ((y.prototype.newGraphManager = function () {
                  ...
                  (e.prototype.initParameters.call(this, arguments),
                    this.isSubLayout ||
                      ...
                      (this.finalTemperature =
                        d.CONVERGENCE_CHECK_PERIOD / this.maxIterations),
                ...
                (y.prototype.getPositionsData = function () {
                  for (
                    var s = this.graphManager.getAllNodes(), f = {}, c = 0;
                    c < s.length;
                    c++
                  ) {
                    var E = s[c].rect,
                ...
                (y.prototype.positionNodesRadially = function (s) {
                  ...
                  this.transform(
                    new a(
                      r.WORLD_CENTER_X - C.x / 2,
                      r.WORLD_CENTER_Y - C.y / 2,
                    ),
                  );
                }),
                ...
                (y.branchRadialLayout = function (s, f, c, E, A, m) {
                  ...
                  f != null && x--;
                  for (
                    var F = 0, U = w.length, P, _ = s.getEdgesBetween(f);
                    _.length > 1;
                  ) {
                    var X = _[0];
                    _.splice(0, 1);
                ...
                (y.prototype.groupZeroDegreeMembers = function () {
                  ...
                  for (
                    var c = [], E = this.graphManager.getAllNodes(), A = 0;
                    A < E.length;
                    A++
                  ) {
                    var m = E[A],
                ...
                (y.prototype.tileCompoundMembers = function (s, f) {
                  ...
                  ((this.tiledMemberPack = []),
                    Object.keys(s).forEach(function (E) {
                      var A = f[E];
                      ((c.tiledMemberPack[E] = c.tileNodes(
                        s[E],
                ...
                (y.prototype.getShortestRowIndex = function (s) {
                  for (
                    var f = -1, c = Number.MAX_VALUE, E = 0;
                    E < s.rows.length;
                    E++
                  )
                ...
                (y.prototype.getLongestRowIndex = function (s) {
                  for (
                    var f = -1, c = Number.MIN_VALUE, E = 0;
                    E < s.rows.length;
                    E++
                  )
                    s.rowWidth[E] > c && ((f = E), (c = s.rowWidth[E]));
                ...
                (y.prototype.findPlaceforPrunedNode = function (s) {
                  ...
                  if (C > 0)
                    for (var F = A; F <= m; F++)
                      x[0] +=
                        this.grid[F][C - 1].length + this.grid[F][C].length - 1;
                  if (m < this.grid.length - 1)
                    for (var F = C; F <= R; F++)
                      x[1] +=
                        this.grid[m + 1][F].length + this.grid[m][F].length - 1;
            ...
            function (I, L, o) {
              ...
              var p = function (u) {
                (u.nodeRepulsion != null &&
                  (i.DEFAULT_REPULSION_STRENGTH = t.DEFAULT_REPULSION_STRENGTH =
                    u.nodeRepulsion),
                  u.idealEdgeLength != null &&
                    (i.DEFAULT_EDGE_LENGTH = t.DEFAULT_EDGE_LENGTH =
                      u.idealEdgeLength),
                  u.edgeElasticity != null &&
                    (i.DEFAULT_SPRING_STRENGTH = t.DEFAULT_SPRING_STRENGTH =
                      u.edgeElasticity),
                  u.nestingFactor != null &&
                    (i.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                      t.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                        u.nestingFactor),
                  u.gravity != null &&
                    (i.DEFAULT_GRAVITY_STRENGTH = t.DEFAULT_GRAVITY_STRENGTH =
                      u.gravity),
                  u.numIter != null &&
                    (i.MAX_ITERATIONS = t.MAX_ITERATIONS = u.numIter),
                  u.gravityRange != null &&
                    (i.DEFAULT_GRAVITY_RANGE_FACTOR =
                      t.DEFAULT_GRAVITY_RANGE_FACTOR =
                        u.gravityRange),
                    ...
                    (T.eles.nodes().positions(function (_, X) {
                      if ((typeof _ == "number" && (_ = X), !_.isParent())) {
                        for (
                          ...
                          ((W =
                            P[B.data("parent")] ||
                            P["DummyCompound_" + B.data("parent")]),
                          (P[H] = W),
                          (B = B.parent()[0]),
                          B != null);
                        );
...
function et(G, b) {
  G.forEach((N) => {
    ...
    (Object.keys(N).forEach((L) => {
      ["id", "label", "height", "width", "padding", "x", "y"].includes(L) ||
        (I[L] = N[L]);
    }),
      b.add({
        group: "nodes",
