import { g as et } from "./chunk-FMBD7UC4-Dsn2JnWt.js";
import { g as tt } from "./chunk-55IACEB6-DbU0WgPO.js";
import { s as st } from "./chunk-QN33PNHL-DsUBJvSL.js";
import {
  _ as A,
  l as Oe,
  c as D,
...
var Ve = (function () {
  var s = A(function (I, c, o, d) {
    ...
    Ne = {
      ...
      performAction: A(function (c, o, d, r, g, e, $) {
        var t = e.length - 1;
        switch (g) {
          case 8:
            this.$ = e[t - 1];
          ...
          case 42:
            ...
            break;
          case 44:
            (r.setCssClass(e[t - 5], e[t - 3]),
              r.addMembers(e[t - 5], e[t - 1]));
            break;
          case 45:
      ...
      table: [
        ...
        s(h, [2, 81], { 13: [1, 139] }),
        s(h, [2, 83], { 13: [1, 141], 77: [1, 140] }),
        s(h, [2, 87], { 13: [1, 142], 80: [1, 143] }),
        { 13: [1, 144] },
        s(h, [2, 95], { 61: Ge }),
        s(Ue, [2, 97], {
          85: 146,
        ...
        s(h, [2, 34]),
        { 41: [1, 151] },
        { 24: 96, 40: 152, 41: [2, 38], 43: 23, 46: n },
        { 45: 153, 51: _e },
        s(z, [2, 42]),
        { 41: [2, 52] },
        s(h, [2, 50]),
      ...
      parseError: A(function (c, o) {
        if (o.recoverable) this.trace(c);
        else {
          var d = new Error(c);
          throw ((d.hash = o), d);
        }
      ...
      parse: A(function (c) {
        ...
        function Ye() {
          ...
          return (
            (_ = r.pop() || k.lex() || Ke),
            typeof _ != "number" &&
              (_ instanceof Array && ((r = _), (_ = r.pop())),
              (_ = o.symbols_[_] || _)),
            _
          );
        }
            ...
            case 2:
              if (
                ...
                (ve = this.performAction.apply(
                  M,
                  [t, ze, oe, O.yy, S[1], g, e].concat(Je),
                )),
                typeof ve < "u")
              )
                return ve;
        ...
        unput: A(function (c) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: d
                ? (d.length === r.length ? this.yylloc.first_column : 0) +
                  r[r.length - d.length].length -
                  d[0].length
                : this.yylloc.first_column - o,
            }),
            this.options.ranges &&
              (this.yylloc.range = [g[0], g[0] + this.yyleng - o]),
...
` +
        ...
        pastInput: A(function () {
          var c = this.matched.substr(
            0,
            this.matched.length - this.match.length,
          );
          return (
            (c.length > 20 ? "..." : "") + c.substr(-20).replace(/\n/g, "")
          );
        }, "pastInput"),
...
` +
        ...
        test_match: A(function (c, o) {
          ...
          if (
            (this.options.backtrack_lexer &&
              ...
              this.options.ranges &&
                (g.yylloc.range = this.yylloc.range.slice(0))),
            (r = c[0].match(/(?:\r\n?|\n).*/g)),
        ...
        next: A(function () {
          ...
          for (var g = this._currentRules(), e = 0; e < g.length; e++)
            if (
              ((d = this._input.match(this.rules[g[e]])),
              d && (!o || d[0].length > o[0].length))
            ) {
              if (((o = d), (r = e), this.options.backtrack_lexer)) {
                if (((c = this.test_match(d, g[e])), c !== !1)) return c;
                if (this._backtrack) {
                  o = !1;
                  continue;
                } else return !1;
          ...
          return o
            ? ((c = this.test_match(o, g[r])), c !== !1 ? c : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        options: {},
        performAction: A(function (o, d, r, g) {
          switch (r) {
            case 0:
              return 62;
            case 1:
...
var Tt = Ve,
      ...
      parseMember(i) {
        ...
        if (this.memberType === "method") {
          ...
          const l = i.length,
            n = i.substring(0, 1),
            p = i.substring(l - 1);
          (We.includes(n) && (this.visibility = n),
            /[$*]/.exec(p) && (a = p),
            (this.id = i.substring(
              this.visibility === "" ? 0 : 1,
              a === "" ? l : l - 1,
  ...
  pe = "classId-",
  Xe = 0,
  V = A((s) => v.sanitizeText(s, D()), "sanitizeText"),
  U,
  kt =
    ((U = class {
      constructor() {
        ((this.relations = []),
              ...
              ee(i)
                ...
                .on("mouseover", (n) => {
                  ...
                  (a.transition().duration(200).style("opacity", ".9"),
                    a
                      ...
                      .style(
                        "left",
                        window.scrollX + C.left + (C.right - C.left) / 2 + "px",
                      )
                      .style(
                        "top",
                        window.scrollY +
                ...
                .on("mouseout", (n) => {
                  (a.transition().duration(500).style("opacity", 0),
                    ee(n.currentTarget).classed("hover", !1));
                }));
          }, "setupToolTips")),
          (this.direction = "TB"),
          (this.setAccTitle = nt),
          ...
          (this.getConfig = A(() => D().class, "getConfig")),
      ...
      addRelation(i) {
        ...
        !a.includes(i.relation.type2)
          ...
          (i.relationTitle1 = v.sanitizeText(i.relationTitle1.trim(), D())),
          (i.relationTitle2 = v.sanitizeText(i.relationTitle2.trim(), D())),
      ...
      addMember(i, a) {
        ...
        if (typeof a == "string") {
          ...
          n.startsWith("<<") && n.endsWith(">>")
            ? l.annotations.push(V(n.substring(2, n.length - 2)))
            : n.indexOf(")") > 0
              ? l.methods.push(new je(n, "method"))
              : n && l.members.push(new je(n, "attribute"));
        }
      }
      addMembers(i, a) {
        Array.isArray(a) &&
        ...
        for (const u of i) {
          ...
          (l === void 0 &&
            ...
            this.classes.forEach((n) => {
              n.cssClasses.includes(u) &&
                n.styles.push(...a.flatMap((p) => p.split(",")));
            }));
        }
      }
      setTooltip(i, a) {
      ...
      setClickFunc(i, a, u) {
        ...
        if (D().securityLevel !== "loose" || a === void 0) return;
        const p = l;
      ...
      getData() {
        ...
        for (const n of this.relations) {
          l++;
          const p = {
            id: dt(n.id1, n.id2, { prefix: "id", counter: l }),
            start: n.id1,
            end: n.id2,
            type: "normal",
            label: n.title,
...
`,
  ...
  Ct = A(async function (s, i, a, u) {
    (Oe.info("REF0:"), Oe.info("Drawing class diagram (v3)", i));
    const { securityLevel: l, state: n, layout: p } = D(),
      f = u.db.getData(),
      C = tt(i, l);
    ((f.type = u.type),
      (f.layoutAlgorithm = it(p)),
      (f.nodeSpacing = n?.nodeSpacing || 50),
      (f.rankSpacing = n?.rankSpacing || 50),
      (f.markers = [
        "aggregation",
        "extension",
        "composition",
