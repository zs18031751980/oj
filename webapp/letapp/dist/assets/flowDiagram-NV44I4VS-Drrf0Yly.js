import { g as q1 } from "./chunk-FMBD7UC4-VajrL-yk.js";
import {
  _ as m,
  o as O1,
  l as $,
...
import { g as le } from "./chunk-55IACEB6-DFsD1jDV.js";
import { s as ce } from "./chunk-QN33PNHL-Bp-R7uq3.js";
import { c as he } from "./channel-CXGY4jjC.js";
    ...
    ((Gt = class {
      constructor() {
        ((this.vertexCounter = 0),
          ...
          (this.funs = []),
          (this.setAccTitle = Q1),
          (this.setAccDescription = J1),
          (this.setDiagramTitle = Z1),
          (this.getAccTitle = $1),
      ...
      lookUpDomId(i) {
        for (const r of this.vertices.values()) if (r.id === i) return r.domId;
        return i;
      }
...
` +
        ...
        if (
          ...
          f.props === void 0
            ? (f.props = c)
            : c !== void 0 && Object.assign(f.props, c),
          u !== void 0)
        ) {
          if (u.shape) {
            if (u.shape !== u.shape.toLowerCase() || u.shape.includes("_"))
              throw new Error(
                `No such shape: ${u.shape}. Shape names should be lowercase.`,
              );
            if (!ae(u.shape)) throw new Error(`No such shape: ${u.shape}.`);
            f.type = u?.shape;
          }
          (u?.label && (f.text = u?.label),
            u?.icon &&
              ((f.icon = u?.icon),
      ...
      addSingleLink(i, r, a, n) {
        ...
        if (
          ...
          const u = this.edges.filter(
            (A) => A.start === c.start && A.end === c.end,
          );
          u.length === 0
            ? (c.id = s1(c.start, c.end, { counter: 0, prefix: "L" }))
            : (c.id = s1(c.start, c.end, {
                counter: u.length + 1,
                prefix: "L",
              }));
        }
...
You have to call mermaid.initialize.`);
      ...
      setClickFun(i, r, a) {
        ...
        if (bt().securityLevel !== "loose" || r === void 0) return;
        let l = [];
        if (typeof a == "string") {
          l = a.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
      ...
      setLink(i, r, a) {
        (i.split(",").forEach((n) => {
          ...
          l !== void 0 &&
            ((l.link = i1.formatUrl(r, this.config)), (l.linkTarget = a));
        }),
          ...
          Et(i)
            ...
            .on("mouseout", (l) => {
              (r.transition().duration(500).style("opacity", 0),
                Et(l.currentTarget).classed("hover", !1));
            }));
      }
      clear(i = "gen-2") {
        ((this.vertices = new Map()),
      ...
      addSubGraph(i, r, a) {
        ...
        const c = m((f) => {
          ...
          b = c.nodeList;
        let u = c.dir;
        const A = bt().flowchart ?? {};
        if (
          ((u =
            u ??
            (A.inheritDir
              ? (this.getDirection() ?? bt().direction ?? void 0)
              : void 0)),
          this.version === "gen-1")
        )
        ...
        return (
          $.info("Adding", y.id, y.nodes, y.dir),
      ...
      destructEndLink(i) {
        ...
        let l = "normal",
          g = a.length - 1;
        (a.startsWith("=") && (l = "thick"),
          a.startsWith("~") && (l = "invisible"));
        const c = this.countChar(".", a);
        return (
          c && ((l = "dotted"), (g = c)),
          { type: n, stroke: l, length: g }
        );
      }
      destructLink(i, r) {
      ...
      addNodeFromVertex(i, r, a, n, l, g) {
        ...
        if (u)
          ...
          b
            ? r.push({ ...A, isGroup: !0, shape: "rect" })
            : r.push({ ...A, isGroup: !1, shape: this.getTypeFromVertex(i) });
        }
      }
      getCompiledStyles(i) {
        let r = [];
        for (const a of i) {
          ...
          (n?.styles && (r = [...r, ...(n.styles ?? [])].map((l) => l.trim())),
            n?.textStyles &&
      ...
      getData() {
        ...
        for (let u = n.length - 1; u >= 0; u--) {
          ...
          for (const y of A.nodes) l.set(y, A.id);
        }
        for (let u = n.length - 1; u >= 0; u--) {
          const A = n[u];
          r.push({
        ...
        return (
          b.forEach((u, A) => {
            const { arrowTypeStart: y, arrowTypeEnd: f } =
                this.destructEdgeType(u.type),
              k = [...(b.defaultStyle ?? [])];
            u.style && k.push(...u.style);
            const x = {
              id: s1(u.start, u.end, { counter: A, prefix: "L" }, u.id),
  ...
  ge = m(async function (s, i, r, a) {
    ($.info("REF0:"), $.info("Drawing state diagram (v2)", i));
    const { securityLevel: n, flowchart: l, layout: g } = bt();
    let c;
    n === "sandbox" && (c = Et("#i" + i));
    ...
    for (const k of u.nodes) {
      ...
      const dt = x.insert(function () {
          return T;
        }, ":first-child"),
        W = x.select(".label-container");
      W &&
        dt.append(function () {
          return W.node();
        });
  ...
  r1 = (function () {
    var s = m(function (gt, h, d, p) {
        for (d = d || {}, p = gt.length; p--; d[gt[p]] = h);
        return d;
      }, "o"),
      i = [1, 4],
      r = [1, 3],
      ...
      wt = [44, 60, 89, 102, 105, 106, 109, 111, 114, 115, 116],
      u1 = [1, 121],
      o1 = [1, 122],
      Kt = [1, 124],
      Yt = [1, 123],
      ...
      w1 = [10, 106],
      ft = [31, 49, 51, 53, 55, 57, 62, 64, 66, 67, 69, 71, 116, 117, 118],
      it = [1, 247],
      rt = [1, 245],
      at = [1, 249],
      nt = [1, 243],
      ...
      Jt = {
        ...
        performAction: m(function (h, d, p, o, B, t, Pt) {
          var e = t.length - 1;
          switch (B) {
            case 2:
              this.$ = [];
        ...
        table: [
          ...
          s(n, [2, 10]),
          s(n, [2, 11]),
          { 8: [1, 54], 9: [1, 55], 10: pt, 15: 53, 18: 56 },
          s(F, [2, 3]),
          s(F, [2, 4]),
          s(F, [2, 5]),
          s(F, [2, 6]),
          ...
          { 8: tt, 9: et, 11: st, 21: 67 },
          { 8: tt, 9: et, 11: st, 21: 68 },
          { 8: tt, 9: et, 11: st, 21: 69 },
          { 8: tt, 9: et, 11: st, 21: 70 },
          { 8: tt, 9: et, 11: st, 21: 71 },
          { 8: tt, 9: et, 10: [1, 72], 11: st, 21: 73 },
          s(F, [2, 36]),
          { 35: [1, 74] },
          { 37: [1, 75] },
          s(F, [2, 39]),
          s(Ct, [2, 50], { 18: 76, 39: 77, 10: pt, 40: a1 }),
          { 10: [1, 79] },
          { 10: [1, 80] },
          { 10: [1, 81] },
          { 10: [1, 82] },
          ...
          s(F, [2, 41]),
          s(F, [2, 42]),
          s(wt, [2, 76], { 73: 116, 62: [1, 118], 74: [1, 117] }),
          { 76: 119, 79: 120, 80: u1, 81: o1, 116: Kt, 119: Yt },
          { 75: [1, 125], 77: [1, 126] },
          s(l1, [2, 83]),
          s(F, [2, 28]),
          s(F, [2, 29]),
          ...
          { 30: 170, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          { 30: 178, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          {
            30: 180,
            50: [1, 179],
            67: E,
          ...
          { 30: 181, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          { 30: 182, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          { 30: 183, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          { 109: [1, 184] },
          { 30: 185, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          {
            30: 186,
            65: [1, 187],
            67: E,
          ...
          { 30: 188, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          { 30: 189, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          { 30: 190, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          s(q, [2, 182]),
          s(n, [2, 20]),
          s(n1, [2, 25]),
          s(Ct, [2, 46], { 39: 191, 18: 192, 10: pt, 40: a1 }),
          s(wt, [2, 73], { 10: [1, 193] }),
          { 10: [1, 194] },
          { 30: 195, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          { 77: [1, 196], 79: 197, 116: Kt, 119: Yt },
          s(It, [2, 79]),
          s(It, [2, 81]),
          s(It, [2, 82]),
          s(It, [2, 168]),
          s(It, [2, 169]),
          { 76: 198, 79: 120, 80: u1, 81: o1, 116: Kt, 119: Yt },
          s(l1, [2, 84]),
          {
            8: tt,
            9: et,
          ...
          { 31: [1, 217], 67: E, 82: 218, 116: C, 117: D, 118: S },
          s(ft, [2, 86]),
          s(ft, [2, 88]),
          s(ft, [2, 89]),
          s(ft, [2, 153]),
          ...
          s(ft, [2, 155]),
          s(ft, [2, 156]),
          { 49: [1, 219], 67: E, 82: 218, 116: C, 117: D, 118: S },
          { 30: 220, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          { 51: [1, 221], 67: E, 82: 218, 116: C, 117: D, 118: S },
          { 53: [1, 222], 67: E, 82: 218, 116: C, 117: D, 118: S },
          { 55: [1, 223], 67: E, 82: 218, 116: C, 117: D, 118: S },
          { 57: [1, 224], 67: E, 82: 218, 116: C, 117: D, 118: S },
          { 60: [1, 225] },
          { 64: [1, 226], 67: E, 82: 218, 116: C, 117: D, 118: S },
          { 66: [1, 227], 67: E, 82: 218, 116: C, 117: D, 118: S },
          { 30: 228, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          { 31: [1, 229], 67: E, 82: 218, 116: C, 117: D, 118: S },
          {
            67: E,
            69: [1, 230],
            71: [1, 231],
          ...
          s(Ct, [2, 45], { 18: 155, 10: pt, 40: V1 }),
          s(Ct, [2, 47], { 44: L1 }),
          s(wt, [2, 75]),
          s(wt, [2, 74]),
          { 62: [1, 234], 67: E, 82: 218, 116: C, 117: D, 118: S },
          s(wt, [2, 77]),
          s(It, [2, 80]),
          { 77: [1, 235], 79: 197, 116: Kt, 119: Yt },
          { 30: 236, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          s(Qt, l, { 5: 237 }),
          s(_, [2, 102]),
          s(F, [2, 35]),
          {
          ...
          s(ft, [2, 87]),
          s(z, [2, 57]),
          { 51: [1, 262], 67: E, 82: 218, 116: C, 117: D, 118: S },
          s(z, [2, 64]),
          s(z, [2, 59]),
          s(z, [2, 60]),
          s(z, [2, 61]),
          ...
          s(z, [2, 63]),
          s(z, [2, 65]),
          { 66: [1, 264], 67: E, 82: 218, 116: C, 117: D, 118: S },
          s(z, [2, 67]),
          s(z, [2, 68]),
          s(z, [2, 70]),
          s(z, [2, 69]),
          ...
          s(wt, [2, 78]),
          { 31: [1, 265], 67: E, 82: 218, 116: C, 117: D, 118: S },
          {
            6: 11,
            7: 12,
            8: g,
          ...
          s(v, [2, 120]),
          s(z, [2, 58]),
          { 30: 282, 67: E, 80: j, 81: K, 82: 171, 116: C, 117: D, 118: S },
          s(z, [2, 66]),
          s(Qt, l, { 5: 283 }),
          s(I1, [2, 131], {
            108: 269,
          ...
          s(v, [2, 114]),
          { 31: [1, 286], 67: E, 82: 218, 116: C, 117: D, 118: S },
          {
            6: 11,
            7: 12,
            8: g,
        ...
        parse: m(function (h) {
          ...
          m(G1, "lex");
          for (var Y, mt, Q, t1, Nt = {}, Ht, ht, P1, Xt; ;) {
            if (
              ((mt = p[p.length - 1]),
              this.defaultActions[mt]
                ? (Q = this.defaultActions[mt])
                : ((Y === null || typeof Y > "u") && (Y = G1()),
                  (Q = Pt[mt] && Pt[mt][Y])),
...
Expecting ` +
            ...
            switch (Q[0]) {
              ...
              case 2:
                if (
                  ((ht = this.productions_[Q[1]][1]),
                  (Nt.$ = B[B.length - ht]),
                  (Nt._$ = {
                    first_line: t[t.length - (ht || 1)].first_line,
                    last_line: t[t.length - 1].last_line,
                    first_column: t[t.length - (ht || 1)].first_column,
                    last_column: t[t.length - 1].last_column,
                  }),
                  K1 &&
                    (Nt._$.range = [
                      t[t.length - (ht || 1)].range[0],
                      t[t.length - 1].range[1],
                    ]),
                  (t1 = this.performAction.apply(
                    Nt,
                    [e, R1, L, kt.yy, Q[1], B, t].concat(j1),
                  )),
                  typeof t1 < "u")
                )
                  return t1;
                (ht &&
                  ...
                  B.push(Nt.$),
                  t.push(Nt._$),
                  (P1 = Pt[p[p.length - 2]][p[p.length - 1]]),
                  p.push(P1));
                break;
              case 3:
                return !0;
          ...
          next: m(function () {
            ...
            for (var B = this._currentRules(), t = 0; t < B.length; t++)
              if (
                ...
                p && (!d || p[0].length > d[0].length))
              ) {
                if (((d = p), (o = t), this.options.backtrack_lexer)) {
                  if (((h = this.test_match(p, B[t])), h !== !1)) return h;
                  if (this._backtrack) {
                    d = !1;
                    continue;
                  } else return !1;
