import { g as te } from "./chunk-55IACEB6-DFsD1jDV.js";
import { s as ee } from "./chunk-QN33PNHL-Bp-R7uq3.js";
import {
  _ as u,
  l as b,
  c as w,
  ...
  Ne = u(async function (t, e, s, a) {
    ...
    try {
      (typeof a.db.getLinks == "function"
        ...
        const v =
          typeof A == "string" ? A : typeof A?.id == "string" ? A.id : "";
        if (!v) {
...
var Z = u((t, e, s, a, r, h, d, S) => {
    ...
    if ((b.info("dataFetcher parsedItem", e, T, m), f !== "root")) {
      ...
      if (
        ...
        t &&
          t.id !== "root" &&
          (b.trace("Setting node ", f, " to be child of its parent ", t.id),
          (k.parentId = t.id)),
        (k.centerLabel = !0),
        e.note)
      ) {
    ...
    e.doc &&
      (b.trace("Adding nodes children "), we(e, e.doc, s, a, r, !h, d, S));
  }, "dataFetcher"),
  $e = u(() => {
    (St.clear(), (G = 0));
  }, "reset"),
        ...
        for (const r of this.nodes)
          if (Array.isArray(r.label)) {
            if (
              ...
              r.isGroup && r.description.length > 0)
            )
              throw new Error(
