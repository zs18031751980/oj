import {
  ...
  aF as sr,
  aG as hr,
} from "./MarkdownComponent-Dj4guaHi.js";
import { p as lr } from "./chunk-4BX2VUAB-CeCflfTV.js";
import { p as fr } from "./treemap-KMMF4GRG-BMiVl7UM.js";
import { c as Fe } from "./cytoscape.esm-BnkdMOzK.js";
import { g as cr } from "./vendor-markdown-HlADSkmp.js";
          ...
          return (function (A) {
            ...
            function (A, P, N) {
              ...
              function i(t, n, s, c) {
                (s == null && c == null && (c = n),
                  ...
                  (this.graphManager = t),
                  s != null && n != null
                    ? (this.rect = new a(n.x, n.y, s.width, s.height))
                    : (this.rect = new a()));
              }
              ...
              ((i.prototype.getEdges = function () {
                ...
                (i.prototype.setRect = function (t, n) {
                  ((this.rect.x = t.x),
                    (this.rect.y = t.y),
                    (this.rect.width = n.width),
                    (this.rect.height = n.height));
                }),
                ...
                (i.prototype.getNeighborsList = function () {
                  var t = new Set(),
                    n = this;
                  return (
                    n.edges.forEach(function (s) {
                      if (s.source == n) t.add(s.target);
                      else {
                        if (s.target != n) throw "Incorrect incidency!";
                        t.add(s.source);
                      }
                    }),
                    t
                ...
                (i.prototype.scatter = function () {
                  ...
                  var f = -r.INITIAL_WORLD_BOUNDARY,
                    T = r.INITIAL_WORLD_BOUNDARY;
                  ((n = r.WORLD_CENTER_Y + e.nextDouble() * (T - f) + f),
                    (this.rect.x = t),
                    (this.rect.y = n));
                }),
                (i.prototype.updateBounds = function () {
                  ...
                  if (this.getChild().getNodes().length != 0) {
                    ...
                    if (
                      ...
                      var n = t.getRight() - t.getLeft(),
                        s = t.getBottom() - t.getTop();
                      (this.labelWidth &&
                        (this.labelPosHorizontal == "left"
                          ? ((this.rect.x -= this.labelWidth),
                            this.setWidth(n + this.labelWidth))
                          : this.labelPosHorizontal == "center" &&
                              this.labelWidth > n
                            ? ((this.rect.x -= (this.labelWidth - n) / 2),
                ...
                (i.prototype.transform = function (t) {
                  ...
                  n > r.WORLD_BOUNDARY
                    ? (n = r.WORLD_BOUNDARY)
                    : n < -r.WORLD_BOUNDARY && (n = -r.WORLD_BOUNDARY);
                  var s = this.rect.y;
                  s > r.WORLD_BOUNDARY
                    ? (s = r.WORLD_BOUNDARY)
            ...
            function (A, P, N) {
              ...
              ((h.MAX_ITERATIONS = 2500),
                ...
                (h.MAX_NODE_DISPLACEMENT =
                  h.MAX_NODE_DISPLACEMENT_INCREMENTAL * 3),
              ...
              ((n.prototype.getNodes = function () {
                ...
                (n.prototype.remove = function (c) {
                  ...
                  if (c instanceof e) {
                    ...
                    for (
                      var T = f.edges.slice(), d, v = T.length, L = 0;
                      L < v;
                      L++
                    )
                      ((d = T[L]),
                ...
                (n.prototype.updateBounds = function (c) {
                  ...
                  (f == h.MAX_VALUE &&
                    ...
                    Y[0].getParent().paddingLeft != null
                      ...
                      : (k = this.margin),
                    (this.left = o.x - k),
                    (this.right = o.x + o.width + k),
                    (this.top = o.y - k),
                    (this.bottom = o.y + o.height + k));
                }),
                ...
                (n.prototype.calcEstimatedSize = function () {
                  for (
                    var c = 0, f = this.nodes, T = f.length, d = 0;
                    d < T;
                    d++
                  ) {
                    var v = f[d];
              ...
              ((a.prototype.addRoot = function () {
                ...
                (a.prototype.add = function (r, e, l, i, g) {
                  if (l == null && i == null && g == null) {
                    ...
                    if (t == n) return ((l.isInterGraph = !1), t.add(l, i, g));
                    if (
                      ((l.isInterGraph = !0),
                      (l.source = i),
                      (l.target = g),
                ...
                (a.prototype.remove = function (r) {
                  if (r instanceof u) {
                    ...
                    var s;
                    g = n.length;
                    for (var t = 0; t < g; t++) ((s = n[t]), e.remove(s));
                ...
                (a.prototype.getAllNodes = function () {
                  if (this.allNodes == null) {
                    for (
                      var r = [], e = this.getGraphs(), l = e.length, i = 0;
                      i < l;
                      i++
                    )
                ...
                (a.prototype.calcInclusionTreeDepths = function (r, e) {
                  ...
                  for (var l, i = r.getNodes(), g = i.length, t = 0; t < g; t++)
                    ((l = i[t]),
                      (l.inclusionTreeDepth = e),
                      l.child != null &&
                        this.calcInclusionTreeDepths(l.child, e + 1));
                }),
            ...
            function (A, P, N) {
              ...
              ((h.calcSeparationAmount = function (a, r, e, l) {
                ...
                (h.getIntersection = function (a, r, e, l) {
                  if (l == null) return this.getIntersection2(a, r, e);
                  var i = a.x,
                    g = a.y,
                    t = r.x,
                    n = r.y,
                ...
                (h.angleOfVector = function (a, r, e, l) {
                  ...
                  return (
                    a !== e
                      ? ((i = Math.atan((l - r) / (e - a))),
                        e < a ? (i += Math.PI) : l < r && (i += this.TWO_PI))
                      : l < r
                ...
                (h.findCircleLineIntersections = function (
                  a,
                  r,
                  e,
                  l,
                  ...
                  var n = (e - a) * (e - a) + (l - r) * (l - r),
                    s = 2 * ((a - i) * (e - a) + (r - g) * (l - r)),
                    c = (a - i) * (a - i) + (r - g) * (r - g) - t * t,
                    f = s * s - 4 * n * c;
                  if (f >= 0) {
                    var T = (-s + Math.sqrt(s * s - 4 * n * c)) / (2 * n),
                      d = (-s - Math.sqrt(s * s - 4 * n * c)) / (2 * n),
                      v = null;
              ...
              var a = function (g) {
                ...
                e = function (g, t) {
                  var n = g.prev,
                    s = g.next;
                  return (
                    n !== null ? (n.next = s) : (t.head = s),
                    s !== null ? (s.prev = n) : (t.tail = n),
                    (g.prev = g.next = null),
                    t.length--,
                    g
                  );
              ...
              ((h.lastID = 0),
                (h.createID = function (a) {
                  return h.isPrimitive(a)
                    ? a
                    : (a.uniqueID != null ||
                        ((a.uniqueID = h.getString()), h.lastID++),
                      a.uniqueID);
                }),
              ...
              function n(s) {
                (t.call(this),
                  ...
                  (this.animationDuringLayout =
                    h.DEFAULT_ANIMATION_DURING_LAYOUT),
              ...
              ((n.RANDOM_SEED = 1),
                ...
                (n.prototype.update2 = function () {
                  if (
                    ...
                    for (
                      var s = this.graphManager.getAllEdges(), c = 0;
                      c < s.length;
                      c++
                    )
                      s[c];
                    for (
                      var f = this.graphManager.getRoot().getNodes(), c = 0;
                      c < f.length;
                      c++
                    )
                      f[c];
                ...
                (n.prototype.initParameters = function () {
                  (this.isSubLayout ||
                    ...
                    (this.incremental = h.DEFAULT_INCREMENTAL),
                    (this.createBendsAsNeeded =
                      h.DEFAULT_CREATE_BENDS_AS_NEEDED),
                    (this.uniformLeafNodeSizes =
                      h.DEFAULT_UNIFORM_LEAF_NODE_SIZES)),
                    this.animationDuringLayout &&
                ...
                (n.prototype.getFlatForest = function () {
                  for (
                    var s = [],
                      c = !0,
                      f = this.graphManager.getRoot().getNodes(),
                      T = !0,
                      d = 0;
                    d < f.length;
                    d++
                ...
                (n.prototype.createBendpointsFromDummyNodes = function () {
                  ...
                  for (var c = 0; c < s.length; c++) {
                    ...
                    if (f.bendpoints.length > 0) {
                      for (
                        var T = this.edgeToDummyNodes.get(f), d = 0;
                        d < T.length;
                        d++
                      ) {
                        var v = T[d],
            ...
            function (A, P, N) {
              ...
              ((i.prototype.initParameters = function () {
                ...
                (i.prototype.calcRepulsionForces = function () {
                  ...
                  if (this.useFRGridVariant)
                    for (
                      ...
                      ((f = d[s]),
                        this.calculateRepulsionForceOfANode(f, v, t, n),
                        v.add(f));
                  else
                ...
                (i.prototype.calcGravitationalForces = function () {
                  for (
                    var t, n = this.getAllNodesToApplyGravitation(), s = 0;
                    s < n.length;
                    s++
                  )
                ...
                (i.prototype.calcRepulsionForce = function (t, n) {
                  var s = t.getRect(),
                    ...
                    k;
                  if (s.intersects(c)) {
                    (e.calcSeparationAmount(s, c, f, a.DEFAULT_EDGE_LENGTH / 2),
                      (G = 2 * f[0]),
                      (k = 2 * f[1]));
                    var Y =
                      (t.noOfChildren * n.noOfChildren) /
                      (t.noOfChildren + n.noOfChildren);
                    ((t.repulsionForceX -= Y * G),
                      (t.repulsionForceY -= Y * k),
                      (n.repulsionForceX += Y * G),
                      (n.repulsionForceY += Y * k));
                  } else
                    (this.uniformLeafNodeSizes &&
                    t.getChild() == null &&
                    n.getChild() == null
                      ...
                      (b = Math.sqrt(L)),
                      (C =
                        ((t.nodeRepulsion / 2 + n.nodeRepulsion / 2) *
                          t.noOfChildren *
                          n.noOfChildren) /
                        L),
                      (G = (C * d) / b),
                ...
                (i.prototype.calcGravitationalForce = function (t) {
                  var n, s, c, f, T, d, v, L;
                  ((n = t.getOwner()),
                    (s = (n.getRight() + n.getLeft()) / 2),
                    (c = (n.getTop() + n.getBottom()) / 2),
                    (f = t.getCenterX() - s),
                    (T = t.getCenterY() - c),
                    (d = Math.abs(f) + t.getWidth() / 2),
                    (v = Math.abs(T) + t.getHeight() / 2),
                    t.getOwner() == this.graphManager.getRoot()
                      ? ((L = n.getEstimatedSize() * this.gravityRangeFactor),
                        (d > L || v > L) &&
                ...
                (i.prototype.calcNoOfChildrenForAllNodes = function () {
                  for (
                    var t, n = this.graphManager.getAllNodes(), s = 0;
                    s < n.length;
                    s++
                  )
                ...
                (i.prototype.calcGrid = function (t) {
                  ...
                  for (var c = new Array(n), f = 0; f < n; f++)
                    c[f] = new Array(s);
                  for (var f = 0; f < n; f++)
                    for (var T = 0; T < s; T++) c[f][T] = new Array();
                  return c;
                }),
                (i.prototype.addNodeToGrid = function (t, n, s) {
                  var c = 0,
                    ...
                    d = 0;
                  ((c = parseInt(
                    Math.floor((t.getRect().x - n) / this.repulsionRange),
                  )),
                    (f = parseInt(
                      Math.floor(
                        (t.getRect().width + t.getRect().x - n) /
                          this.repulsionRange,
                      ),
                    )),
                    (T = parseInt(
                      Math.floor((t.getRect().y - s) / this.repulsionRange),
                    )),
                    (d = parseInt(
                      Math.floor(
                        (t.getRect().height + t.getRect().y - s) /
                          this.repulsionRange,
                      ),
                    )));
                  for (var v = c; v <= f; v++)
                ...
                (i.prototype.calculateRepulsionForceOfANode = function (
                  ...
                  if (
                    ...
                    for (
                      var T, d = this.grid, v = t.startX - 1;
                      v < t.finishX + 2;
                      v++
                    )
            ...
            function (A, P, N) {
              ...
              ((h.prototype.add = function (a) {
                ...
                (h.prototype.addAllTo = function (a) {
                  for (
                    var r = Object.keys(this.set), e = r.length, l = 0;
                    l < e;
                    l++
                  )
                    a.push(this.set[r[l]]);
            ...
            function (A, P, N) {
              ...
              ((u.multMat = function (h, a) {
                ...
                (u.multGamma = function (h) {
                  ...
                  r *= -1 / h.length;
                  for (var l = 0; l < h.length; l++) a[l] = r + h[l];
                  return a;
                }),
                    ...
                    u(e, [
                      {
                        ...
                        value: function (i, g, t) {
                          if (g < t) {
                            ...
                            (this._quicksort(i, g, n),
                              this._quicksort(i, n + 1, t));
                          }
                        },
                      },
                      {
              ...
              ((u.svd = function (h) {
                ...
                for (
                  ...
                  if (t < g) {
                    ...
                    if (r[t] !== 0) {
                      r[t + 1] < 0 && (r[t] = -r[t]);
                      for (var b = t + 1; b < this.n; b++) r[b] /= r[t];
                      r[t + 1] += 1;
                    }
                    if (
                      ((r[t] = -r[t]),
                ...
                for (
                  var $ = o - 1, _ = Math.pow(2, -52), ht = Math.pow(2, -966);
                  o > 0;
                ) {
                  var Q = void 0,
                    It = void 0;
                  ...
                  if (Q === o - 2) It = 4;
                    ...
                    for (Nt = o - 1; Nt >= Q && Nt !== Q; Nt--) {
                      var vt =
                        (Nt !== o ? Math.abs(r[Nt]) : 0) +
                        (Nt !== Q + 1 ? Math.abs(r[Nt - 1]) : 0);
                    ...
                    case 1:
                      {
                        ...
                        for (var gt = o - 2; gt >= Q; gt--) {
                          ...
                          for (var Et = 0; Et < this.n; Et++)
                            ((mt =
                              At * this.V[Et][gt] + Ot * this.V[Et][o - 1]),
                              (this.V[Et][o - 1] =
                                -Ot * this.V[Et][gt] + At * this.V[Et][o - 1]),
                              (this.V[Et][gt] = mt));
                        }
                      }
                      break;
                    case 2:
                      {
                        ...
                        for (var Rt = Q; Rt < o; Rt++) {
                          ...
                          for (var Ft = 0; Ft < this.m; Ft++)
                            ((Ht =
                              Ut * this.U[Ft][Rt] + Pt * this.U[Ft][Q - 1]),
                              (this.U[Ft][Q - 1] =
                                -Pt * this.U[Ft][Rt] + Ut * this.U[Ft][Q - 1]),
                              (this.U[Ft][Rt] = Ht));
                        }
                      }
                      break;
                    case 3:
                      {
                        ...
                        (function (Tt, Ct) {
                          ...
                          (ct = at / (Z + ct)));
                        for (
                          var nt = (B + Vt) * (B - Vt) + ct, tt = B * J, j = Q;
                          j < o - 1;
                          j++
                        ) {
                          ...
                          for (var xt = 0; xt < this.n; xt++)
                            ((ut = Mt * this.V[xt][j] + pt * this.V[xt][j + 1]),
                              (this.V[xt][j + 1] =
                                -pt * this.V[xt][j] + Mt * this.V[xt][j + 1]),
                              (this.V[xt][j] = ut));
                          if (
                            ((ut = u.hypot(nt, tt)),
                            (Mt = nt / ut),
                            ...
                            for (var lt = 0; lt < this.m; lt++)
                              ((ut =
                                Mt * this.U[lt][j] + pt * this.U[lt][j + 1]),
                                (this.U[lt][j + 1] =
                                  -pt * this.U[lt][j] + Mt * this.U[lt][j + 1]),
                                (this.U[lt][j] = ut));
                        }
                        r[o - 2] = nt;
                      }
              ...
              var a = (function () {
                function r(e, l) {
                  ...
                  for (var n = 0; n < this.iMax; n++) {
                    ...
                    for (var s = 0; s < this.jMax; s++) this.grid[n][s] = 0;
                  }
                    ...
                    },
                    {
                      ...
                      value: function () {
                        for (var l = 1; l < this.jMax; l++)
                          ((this.grid[0][l] =
                            this.grid[0][l - 1] + this.gap_penalty),
                        ...
                        for (var g = 1; g < this.iMax; g++)
                          for (var t = 1; t < this.jMax; t++) {
                            ...
                            this.sequence1[g - 1] === this.sequence2[t - 1]
                              ? (n = this.grid[g - 1][t - 1] + this.match_score)
                              : (n =
                                  this.grid[g - 1][t - 1] +
          ...
          return (() => {
            var P = {
                45: (a, r, e) => {
                  var l = {};
                  ((l.layoutBase = e(551)),
                    (l.CoSEConstants = e(806)),
                    (l.CoSEEdge = e(767)),
                    (l.CoSEGraph = e(880)),
                    (l.CoSEGraphManager = e(578)),
                    (l.CoSELayout = e(765)),
                    (l.CoSENode = e(991)),
                    (l.ConstraintHandler = e(902)),
                    (a.exports = l));
                },
                806: (a, r, e) => {
                ...
                765: (a, r, e) => {
                  ...
                  ((O.prototype.newGraphManager = function () {
                      ...
                      (l.prototype.initParameters.call(this, arguments),
                        this.isSubLayout ||
                          ...
                          (this.gravityRangeFactor =
                            f.DEFAULT_GRAVITY_RANGE_FACTOR),
                          (this.compoundGravityRangeFactor =
                    ...
                    (O.prototype.tick = function () {
                      ...
                      if (
                        this.totalIterations % f.CONVERGENCE_CHECK_PERIOD ==
                          0 &&
                        !this.isTreeGrowing &&
                        !this.isGrowthFinished
                      ) {
                        ...
                        if (this.growTreeIterations % 10 == 0)
                          if (this.prunedNodesAll.length > 0) {
                            (this.graphManager.updateBounds(),
                              ...
                              this.graphManager.resetAllNodesToApplyGravitation());
                            var o = new Set(this.getAllNodes()),
                    ...
                    (O.prototype.getPositionsData = function () {
                      for (
                        var o = this.graphManager.getAllNodes(), m = {}, p = 0;
                        p < o.length;
                        p++
                      ) {
                        var E = o[p].rect,
                    ...
                    (O.prototype.moveNodes = function () {
                      ...
                      for (var p = 0; p < o.length; p++) ((m = o[p]), m.move());
                    }),
                    (O.prototype.initConstraintVariables = function () {
                      ...
                      var y = function w(H) {
                        for (
                          var $ = H.getChild().getNodes(), _, ht = 0, Q = 0;
                          Q < $.length;
                          Q++
                        )
                          ((_ = $[Q]),
                            _.getChild() == null
                              ? o.fixedNodeSet.has(_.id) && (ht += 100)
                              : (ht += w(_)));
                        return ht;
                      };
                      ...
                      if (this.constraints.relativePlacementConstraint) {
                        ...
                        if (
                          ...
                          this.fixedNodeSet.forEach(function (w) {
                            (o.fixedNodesOnHorizontal.add(w),
                              o.fixedNodesOnVertical.add(w));
                          }),
                            ...
                            for (
                              ...
                              (this.dummyToNodeForVerticalAlignment.set(
                                ...
                                W[p].forEach(function (H) {
                                  (M.set(H, "dummy" + p),
                                    o.dummyToNodeForVerticalAlignment
                                      .get("dummy" + p)
                                      .push(H),
                                    o.fixedNodeSet.has(H) &&
                                      o.fixedNodesOnHorizontal.add(
                                        "dummy" + p,
                                      ));
                                }));
                            ...
                            for (
                              ...
                              (this.dummyToNodeForHorizontalAlignment.set(
                                ...
                                x[p].forEach(function (H) {
                                  (S.set(H, "dummy" + p),
                                    o.dummyToNodeForHorizontalAlignment
                                      .get("dummy" + p)
                                      .push(H),
                                    o.fixedNodeSet.has(H) &&
                                      o.fixedNodesOnVertical.add("dummy" + p));
                                }));
                        }
                                ...
                                if (w.left) {
                                  var H = M.has(w.left)
                                    ...
                                    $ = M.has(w.right)
                                      ? M.get(w.right)
                                      : w.right;
                                  (o.nodesInRelativeHorizontal.includes(H) ||
                                    (o.nodesInRelativeHorizontal.push(H),
                                    o.nodeToRelativeConstraintMapHorizontal.set(
                                      H,
                                      [],
                                    ),
                                    o.dummyToNodeForVerticalAlignment.has(H)
                                      ? o.nodeToTempPositionMapHorizontal.set(
                                          H,
                                          o.idToNodeMap
                                            .get(
                                              o.dummyToNodeForVerticalAlignment.get(
                                                H,
                                              )[0],
                                            )
                                            .getCenterX(),
                                      ...
                                      : o.nodeToTempPositionMapHorizontal.set(
                                          H,
                                          o.idToNodeMap.get(H).getCenterX(),
                                        )),
                                    o.nodesInRelativeHorizontal.includes($) ||
                                      (o.nodesInRelativeHorizontal.push($),
                                      o.nodeToRelativeConstraintMapHorizontal.set(
                                        $,
                                        [],
                                      ),
                                      o.dummyToNodeForVerticalAlignment.has($)
                                        ? o.nodeToTempPositionMapHorizontal.set(
                                            $,
                                            o.idToNodeMap
                                              .get(
                                        ...
                                        : o.nodeToTempPositionMapHorizontal.set(
                                            $,
                                            o.idToNodeMap.get($).getCenterX(),
                                          )),
                                    o.nodeToRelativeConstraintMapHorizontal
                                      .get(H)
                                  ...
                                  var _ = S.has(w.top) ? S.get(w.top) : w.top,
                                    ht = S.has(w.bottom)
                                      ? S.get(w.bottom)
                                      : w.bottom;
                                  (o.nodesInRelativeVertical.includes(_) ||
                                    (o.nodesInRelativeVertical.push(_),
                                    o.nodeToRelativeConstraintMapVertical.set(
                                      _,
                                      [],
                                    ),
                                    o.dummyToNodeForHorizontalAlignment.has(_)
                                      ? o.nodeToTempPositionMapVertical.set(
                                          _,
                                          o.idToNodeMap
                                            .get(
                                              o.dummyToNodeForHorizontalAlignment.get(
                                                _,
                                              )[0],
                                            )
                                            .getCenterY(),
                                      ...
                                      : o.nodeToTempPositionMapVertical.set(
                                          _,
                                          o.idToNodeMap.get(_).getCenterY(),
                                        )),
                                    o.nodesInRelativeVertical.includes(ht) ||
                                      (o.nodesInRelativeVertical.push(ht),
                                      o.nodeToRelativeConstraintMapVertical.set(
                                        ht,
                                        [],
                                      ),
                                      o.dummyToNodeForHorizontalAlignment.has(
                                        ht,
                                      )
                                        ? o.nodeToTempPositionMapVertical.set(
                                            ht,
                                        ...
                                        : o.nodeToTempPositionMapVertical.set(
                                            ht,
                                            o.idToNodeMap.get(ht).getCenterY(),
                                          )),
                                    o.nodeToRelativeConstraintMapVertical
                                      .get(_)
                              ...
                              return (
                                H.forEach(function (vt, rt) {
                                  if (!It.has(rt)) {
                                    ...
                                    var gt = rt;
                                    for (
                                      Q.push(gt), It.add(gt), _[Nt].push(gt);
                                      Q.length != 0;
                                    ) {
                                      ((gt = Q.shift()),
                                        $.has(gt) && (ht[Nt] = !0));
                        ...
                        if (s.RELAX_MOVEMENT_ON_CONSTRAINTS)
                          (this.totalIterations % 10 == 0 &&
                            ...
                            this.nodesInRelativeHorizontal.forEach(
                              function (z) {
                                if (!o.fixedNodesOnHorizontal.has(z)) {
                                  var w = 0;
                                  (o.dummyToNodeForVerticalAlignment.has(z)
                                    ? (w = o.idToNodeMap.get(
                                        o.dummyToNodeForVerticalAlignment.get(
                                          z,
                                        )[0],
                                      ).displacementX)
                                    : (w = o.idToNodeMap.get(z).displacementX),
                                    o.nodeToRelativeConstraintMapHorizontal
                                      .get(z)
                                      .forEach(function (H) {
                                        if (H.right) {
                                          var $ =
                                            o.nodeToTempPositionMapHorizontal.get(
                                              H.right,
                                            ) -
                                            o.nodeToTempPositionMapHorizontal.get(
                                              z,
                                    ...
                                    o.nodeToTempPositionMapHorizontal.set(
                                      z,
                                      o.nodeToTempPositionMapHorizontal.get(z) +
                                        w,
                                    ),
                                    o.dummyToNodeForVerticalAlignment.has(z)
                                      ? o.dummyToNodeForVerticalAlignment
                                          .get(z)
                                          .forEach(function (H) {
                                            o.idToNodeMap.get(H).displacementX =
                                              w;
                                          })
                                      : (o.idToNodeMap.get(z).displacementX =
                                          w));
                                }
                              },
                            ),
                            this.nodesInRelativeVertical.forEach(function (z) {
                              if (!o.fixedNodesOnHorizontal.has(z)) {
                                var w = 0;
                                (o.dummyToNodeForHorizontalAlignment.has(z)
                                  ? (w = o.idToNodeMap.get(
                                      o.dummyToNodeForHorizontalAlignment.get(
                                        z,
                                      )[0],
                                    ).displacementY)
                                  : (w = o.idToNodeMap.get(z).displacementY),
                                  o.nodeToRelativeConstraintMapVertical
                                    .get(z)
                                    .forEach(function (H) {
                                      if (H.bottom) {
                                        var $ =
                                          o.nodeToTempPositionMapVertical.get(
                                            H.bottom,
                                          ) -
                                          o.nodeToTempPositionMapVertical.get(
                                            z,
                                  ...
                                  o.nodeToTempPositionMapVertical.set(
                                    z,
                                    o.nodeToTempPositionMapVertical.get(z) + w,
                                  ),
                                  o.dummyToNodeForHorizontalAlignment.has(z)
                                    ? o.dummyToNodeForHorizontalAlignment
                                        .get(z)
                                        .forEach(function (H) {
                                          o.idToNodeMap.get(H).displacementY =
                                            w;
                                        })
                              ...
                              for (var y = 0; y < x.length; y++)
                                this.dummyToNodeForHorizontalAlignment.has(x[y])
                                  ? this.dummyToNodeForHorizontalAlignment
                                      .get(x[y])
                                      .forEach(function ($) {
                                        o.idToNodeMap.get($).displacementY = 0;
                                      })
                    ...
                    (O.prototype.calculateNodesToApplyGravitationTo =
                      function () {
                        ...
                        for (y = 0; y < E; y++)
                          ((m = p[y]),
                            m.updateConnected(),
                            m.isConnected || (o = o.concat(m.getNodes())));
                        return o;
                      }),
                    ...
                    (O.prototype.positionNodesRadially = function (o) {
                      for (
                        var m = new d(0, 0),
                          p = Math.ceil(Math.sqrt(o.length)),
                          E = 0,
                          y = 0,
                          R = 0,
                          M = new v(0, 0),
                        ...
                        ((m.x = R),
                          ...
                          (R = Math.floor(
                            M.x + s.DEFAULT_COMPONENT_SEPERATION,
                          )));
                      }
                      this.transform(
                        new v(
                          T.WORLD_CENTER_X - M.x / 2,
                          T.WORLD_CENTER_Y - M.y / 2,
                        ),
                      );
                    }),
                    (O.radialLayout = function (o, m, p) {
                      var E = Math.max(
                        this.maxDiagonalInTree(o),
                        s.DEFAULT_RADIAL_SEPARATION,
                      );
                      O.branchRadialLayout(m, null, 0, 359, 0, E);
                      var y = k.calculateBounds(o),
                        R = new Y();
                    ...
                    (O.branchRadialLayout = function (o, m, p, E, y, R) {
                      ...
                      m != null && X--;
                      for (
                        var et = 0, z = V.length, w, H = o.getEdgesBetween(m);
                        H.length > 1;
                      ) {
                        var $ = H[0];
                        H.splice(0, 1);
                      ...
                      Object.keys(m).forEach(function (W) {
                        if (m[W].length > 1) {
                          ...
                          ((V.id = x),
                            ...
                            (o.idToDummyNode[x] = V));
                          var X = o.getGraphManager().add(o.newGraph(), V),
                            et = q.getChild();
                          et.add(V);
                    ...
                    (O.prototype.clearCompounds = function () {
                      ...
                      for (var p = 0; p < this.compoundOrder.length; p++)
                        ((m[this.compoundOrder[p].id] = this.compoundOrder[p]),
                          (o[this.compoundOrder[p].id] = [].concat(
                    ...
                    (O.prototype.adjustLocations = function (
                      o,
                      m,
                      p,
                      E,
                      ...
                      for (var S = m, W = 0; W < o.rows.length; W++) {
                        ...
                        for (var q = 0, V = 0; V < x.length; V++) {
                          ...
                          ((X.rect.x = m),
                            (X.rect.y = p),
                            (m += X.rect.width + o.horizontalPadding),
                    ...
                    (O.prototype.tileNodes = function (o, m) {
                      var p = this.tileNodesByFavoringDim(o, m, !0),
                        E = this.tileNodesByFavoringDim(o, m, !1),
                    ...
                    (O.prototype.tileNodesByFavoringDim = function (o, m, p) {
                      ...
                      for (var V = 0; V < o.length; V++) {
                        ...
                        if (M.rows.length == 0)
                          ...
                          this.canAddHorizontal(M, X.rect.width, X.rect.height)
                        ) {
                    ...
                    (O.prototype.insertNodeToRow = function (o, m, p, E) {
                      ...
                      (o.rows[p].length > 0 && (M += o.horizontalPadding),
                        (o.rowWidth[p] = M),
                        o.width < M && (o.width = M));
                      var S = m.rect.height;
                    ...
                    (O.prototype.canAddHorizontal = function (o, m, p) {
                      ...
                      o.rowHeight[R] < p &&
                        R > 0 &&
                        (S = p + o.verticalPadding - o.rowHeight[R]);
                      var W;
                      (o.width - M >= m + o.horizontalPadding
                        ? (W = (o.height + S) / (M + m + o.horizontalPadding))
                        : (W = (o.height + S) / o.width),
                        (S = p + o.verticalPadding));
                      var x;
                      return (
                        o.width < m
                          ? (x = (o.height + S) / m)
                          : (x = (o.height + S) / o.width),
                        x < 1 && (x = 1 / x),
                        W < 1 && (W = 1 / W),
                        W < x
                      );
                    ...
                    (O.prototype.shiftToLastRow = function (o) {
                      var m = this.getLongestRowIndex(o),
                        p = o.rowWidth.length - 1,
                        E = o.rows[m],
                        y = E[E.length - 1],
                        R = y.width + o.horizontalPadding;
                      if (o.width - o.rowWidth[p] > R && m != p) {
                        (E.splice(-1, 1),
                          o.rows[p].push(y),
                          (o.rowWidth[m] = o.rowWidth[m] - R),
                          (o.rowWidth[p] = o.rowWidth[p] + R),
                          (o.width =
                            o.rowWidth[instance.getLongestRowIndex(o)]));
                        ...
                        ((o.rowHeight[m] = M),
                          o.rowHeight[p] < y.height + o.verticalPadding &&
                            (o.rowHeight[p] = y.height + o.verticalPadding));
                    ...
                    (O.prototype.findPlaceforPrunedNode = function (o) {
                      ...
                      if (
                        ...
                        E.setCenter(
                          p.getCenterX() + o[3].getWidth(),
                          p.getCenterY() + o[3].getHeight(),
                        );
                      else {
                        var y = p.startX,
                          R = p.finishX,
                        ...
                        if (M > 0)
                          for (var et = y; et <= R; et++)
                            X[0] +=
                              this.grid[et][M - 1].length +
                              this.grid[et][M].length -
                              1;
                        if (R < this.grid.length - 1)
                          for (var et = M; et <= S; et++)
                            X[1] +=
                              this.grid[R + 1][et].length +
                              this.grid[R][et].length -
                              1;
                        if (S < this.grid[0].length - 1)
                          for (var et = y; et <= R; et++)
                            X[2] +=
                              this.grid[et][S + 1].length +
                              this.grid[et][S].length -
                              1;
                        if (y > 0)
                          for (var et = M; et <= S; et++)
                            X[3] +=
                  ...
                  ((g.prototype.calculateDisplacement = function () {
                    ...
                    (this.getChild() != null && this.fixedNodeWeight
                      ...
                      Math.abs(this.displacementX) >
                        n.coolingFactor * n.maxNodeDisplacement &&
                        (this.displacementX =
                          n.coolingFactor *
                          n.maxNodeDisplacement *
                    ...
                    (g.prototype.propogateDisplacementToChildren = function (
                      ...
                      for (
                        var c = this.getChild().getNodes(), f, T = 0;
                        T < c.length;
                        T++
                      )
                        ((f = c[T]),
                          f.getChild() == null
                            ? ((f.displacementX += n), (f.displacementY += s))
                            : f.propogateDisplacementToChildren(n, s));
                    }),
                ...
                902: (a, r, e) => {
                  ...
                  ((s.handleConstraints = function (c) {
                            ...
                            ? (ut.push(ot),
                              J ||
                                (B == "horizontal"
                                  ? tt.set(
                                      ot,
                                      d.has(ot) ? v[d.get(ot)] : Z.get(ot),
                                    )
                                  : tt.set(
                                      ot,
                                      d.has(ot) ? L[d.get(ot)] : Z.get(ot),
                                    )))
                              ...
                              if (
                                ...
                                (ot.forEach(function (st) {
                                  B == "horizontal"
                                    ? (tt.set(
                                        st,
                                        d.has(st) ? v[d.get(st)] : Z.get(st),
                                      ),
                                      (Lt += tt.get(st)))
                                    : (tt.set(
                                        st,
                                        d.has(st) ? L[d.get(st)] : Z.get(st),
                                      ),
                                      (Lt += tt.get(st)));
                                }),
                                  (Lt = Lt / ot.length),
                        ...
                        return (
                          U.forEach(function (ct, nt) {
                            if (!Z.has(nt)) {
                              ...
                              var tt = nt;
                              for (
                                J.push(tt), Z.add(tt), B[at].push(tt);
                                J.length != 0;
                              ) {
                                tt = J.shift();
                                var j = U.get(tt);
                    ...
                    if (
                      ...
                      if (
                        f.fixedNodeConstraint &&
                        f.fixedNodeConstraint.length > 1
                      )
                        ...
                        (function () {
                          ...
                          if (f.alignmentConstraint.horizontal) {
                            for (
                              var Z = f.alignmentConstraint.horizontal,
                                at = function (tt) {
                                  var j = new Set();
                    ...
                    if (i.ENFORCE_CONSTRAINTS) {
                      if (
                        f.fixedNodeConstraint &&
                        f.fixedNodeConstraint.length > 0
                      ) {
                        var Et = { x: 0, y: 0 };
                        (f.fixedNodeConstraint.forEach(function (F, U) {
                          var B = {
                ...
                548: (a, r, e) => {
                  var l = (function () {
                      function t(n, s) {
                        ...
                        try {
                          for (
                            var v = n[Symbol.iterator](), L;
                            !(f = (L = v.next()).done) &&
                            (c.push(L.value), !(s && c.length === s));
                            f = !0
                          );
                        } catch (b) {
                          ((T = !0), (d = b));
                      ...
                      return function (n, s) {
                        ...
                        if (Symbol.iterator in Object(n)) return t(n, s);
                        throw new TypeError(
                  ...
                  ((g.getTopMostNodes = function (t) {
                    ...
                    (g.connectComponents = function (t, n, s, c) {
                      var f = new i(),
                        ...
                        K = function () {
                          ...
                          var o = s[0],
                            m = t.collection();
                          (m.merge(o).merge(o.descendants().intersection(n)),
                            d.push(o),
                          ...
                          for (
                            var p = function () {
                              ...
                              o.neighborhood()
                                .nodes()
                                .forEach(function (x) {
                                  n.intersection(o.edgesWith(x)).length > 0 &&
                                    R.merge(x);
                                });
                          ...
                          if (
                            (it.forEach(function (y) {
                              n.intersection(y.connectedEdges()).forEach(
                                function (R) {
                                  it.has(R.source()) &&
                                    it.has(R.target()) &&
                                    it.merge(R);
                    ...
                    (g.relocateComponent = function (t, n, s) {
                      if (!s.fixedNodeConstraint) {
                        ...
                        if (s.quality == "draft") {
                          ...
                          try {
                            for (
                              var C = n.nodeIndexes[Symbol.iterator](), G;
                              !(v = (G = C.next()).done);
                              v = !0
                            ) {
                              var k = G.value,
                    ...
                    (g.calcBoundingBox = function (t, n, s, c) {
                      for (
                        ...
                        var O = k[K];
                        ((L = n[c.get(O.id())] - O.width() / 2),
                          (b = n[c.get(O.id())] + O.width() / 2),
                    ...
                    (g.calcParentsWithoutChildren = function (t, n) {
                      var s = t.collection();
                      return (
                        n.nodes(":parent").forEach(function (c) {
                          var f = !1;
                  ...
                  var l = e(548),
                    ...
                    T = function (v, L) {
                      var b = v.cy,
                        ...
                        it = {};
                      v.randomize &&
                        ((Y = L.nodeIndexes), (K = L.xCoords), (O = L.yCoords));
                      var o = function (x) {
                                ...
                                if (!w.isParent())
                                  $ = x.add(
                                    new g(
                                      ...
                                      new n(parseFloat(_.w), parseFloat(_.h)),
                                    ),
                                  );
                                else {
                      ...
                      (v.nestingFactor != null &&
                        ...
                        (s.DEFAULT_UNIFORM_LEAF_NODE_SIZES =
                          v.uniformNodeDimensions),
                        v.step == "transformed" &&
                              ...
                              (C.fixedNodeConstraint &&
                                ...
                                C.alignmentConstraint &&
                                  (C.alignmentConstraint.vertical &&
                                    (!Array.isArray(
                                      ...
                                      C.alignmentConstraint.vertical.length ==
                                        0) &&
                                  ...
                                  C.alignmentConstraint.horizontal &&
                                    (!Array.isArray(
                                      ...
                                      C.alignmentConstraint.horizontal.length ==
                                        0) &&
                                    (C.alignmentConstraint.horizontal =
                                      void 0)),
                                C.relativePlacementConstraint &&
                                  (!Array.isArray(
                                    ...
                                    C.relativePlacementConstraint.length ==
                                      0) &&
                    ...
                    t = function (s) {
                            ...
                            for (var tt = 0; tt < S; tt++)
                              ((ct[nt][tt] = 0),
                                nt == tt &&
                                  (ct[nt][tt] =
                                    B[nt] /
                                    (B[nt] * B[nt] + at / (B[nt] * B[nt]))));
                          }
                          o = i.multMat(i.multMat(Z, ct), i.transpose(J));
                        },
                        X = function () {
                          for (
                            var U = void 0,
                          ...
                          for (j = E; ;) {
                            ...
                            if (
                              ((ct = i.minusOp(
                                ct,
                                i.multCons(at, i.dotProduct(at, ct)),
                              )),
                              (Z = i.multGamma(i.multL(i.multGamma(ct), O, o))),
                              (B = i.dotProduct(ct, Z)),
                              (Z = i.normalize(Z)),
                          ...
                          ((G = i.multCons(at, Math.sqrt(Math.abs(U)))),
                            (k = i.multCons(ct, Math.sqrt(Math.abs(B)))));
                        };
                      ...
                      (d.forEach(function (F) {
                        ...
                        (U.nodes(":childless").forEach(function (Z, at) {
                          Z.connectedEdges().length < J &&
                            ((J = Z.connectedEdges().length), (B = at));
                        }),
    ...
    ((ae = class {
      ...
      addService({ id: D, icon: A, in: P, title: N, iconText: u }) {
        ...
        if (P !== void 0) {
          if (D === P)
            throw new Error(
              `The service [${D}] cannot be placed within itself`,
            );
      ...
      addJunction({ id: D, in: A }) {
        ((this.registeredIds[D] = "node"),
          (this.nodes[D] = { id: D, type: "junction", edges: [], in: A }));
      }
      getJunctions() {
      ...
      addGroup({ id: D, icon: A, in: P, title: N }) {
        ...
        ((this.registeredIds[D] = "group"),
          (this.groups[D] = { id: D, icon: A, title: N, in: P }));
      }
      getGroups() {
        ...
        if (this.dataStructures === void 0) {
          const D = {},
            A = Object.entries(this.nodes).reduce(
              (r, [e, l]) => (
                (r[e] = l.edges.reduce((i, g) => {
                  const t = this.getNode(g.lhsId)?.in,
                    n = this.getNode(g.rhsId)?.in;
                  if (t && n && t !== n) {
        ...
        if (
          ...
          c &&
            (Wt(n)
              ...
              : (C += n === "T" ? -G : G + 18)),
          !g &&
            A.getNode(e)?.type === "junction" &&
            (Wt(l) ? (T += l === "L" ? u : -u) : (d += l === "T" ? u : -u)),
          !c &&
            A.getNode(t)?.type === "junction" &&
            (Wt(n) ? (b += n === "L" ? u : -u) : (C += n === "T" ? u : -u)),
          ...
          if (f) {
            ...
            if (
              ...
              O.attr(
                "transform",
                "translate(" + v + ", " + L + ") rotate(-90)",
              );
            else if (Y === "XY") {
              const it = ye(l, n);
              if (it && Nr(it)) {
                const o = O.node().getBoundingClientRect(),
                  [m, p] = Ar(it);
                O.attr("dominant-baseline", "auto").attr(
                  "transform",
                  `rotate(${-1 * m * p * 45})`,
                );
  ...
  Fr = dt(async function (I, D, A) {
    ...
    await Promise.all(
      D.nodes().map(async (r) => {
        const e = ie(r);
        if (e.type === "group") {
          const { h: l, w: i, x1: g, y1: t } = r.boundingBox(),
            n = I.append("rect");
          n.attr("id", `group-${e.id}`)
            .attr("x", g + a)
            .attr("y", t + a)
            .attr("width", i)
            .attr("height", l)
...
function Ve(I, D, A) {
  const P = dt(
      (a, r) =>
        Object.entries(a).reduce((e, [l, i]) => {
          let g = 0;
          const t = Object.entries(i);
          if (t.length === 1) return ((e[l] = t[0][1]), e);
    ...
    N = D.map((a) => {
      ...
      return (
        ...
        {
          horiz: Object.values(P(r, "horizontal")).filter((l) => l.length > 1),
          vert: Object.values(P(e, "vertical")).filter((l) => l.length > 1),
        }
      );
    }),
    [u, h] = N.reduce(
  ...
  return new Promise((a) => {
    ...
    (g.one("layoutstop", () => {
      function t(n, s, c, f) {
        ...
        ((d =
          (f - L + ((v - c) * (L - C)) / (v - b)) /
          Math.sqrt(1 + Math.pow((L - C) / (v - b), 2))),
          (T = Math.sqrt(
            Math.pow(f - L, 2) + Math.pow(c - v, 2) - Math.pow(d, 2),
          )));
        ...
        return (
          (d = Math.abs(d) * k),
          (T = T * Y),
          { distances: d, weights: T }
        );
      }
      (dt(t, "getSegmentWeights"), e.startBatch());
      for (const n of Object.values(e.edges()))
        if (n.data?.()) {
          const { x: s, y: c } = n.source().position(),
            { x: f, y: T } = n.target().position();
          if (s !== f && c !== T) {
            const d = n.sourceEndpoint(),
              v = n.targetEndpoint(),
              { sourceDir: L } = be(n),
              [b, C] = qt(L) ? [d.x, v.y] : [v.x, d.y],
              { weights: G, distances: k } = t(d, v, b, C);
            (n.style("segment-distances", k), n.style("segment-weights", G));
          }
        }
      (e.endBatch(), g.run());
    }),
