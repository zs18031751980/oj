...
import { s as he } from "./chunk-QN33PNHL-Bp-R7uq3.js";
import {
  _ as l,
  l as I,
  p as de,
...
var X = (function () {
  var t = l(function (x, s, i, o) {
    ...
    F = {
      ...
      performAction: l(function (s, i, o, a, g, r, w) {
        var d = r.length - 1;
        switch (g) {
          case 6:
          case 7:
          ...
          case 12:
            ...
            break;
          case 15:
            (a.getLogger().info("Node: ", r[d].id),
              a.addNode(r[d - 1].length, r[d].id, r[d].descr, r[d].type));
            break;
          case 16:
            (a.getLogger().trace("Icon: ", r[d]),
          ...
          case 18:
            ...
            break;
          case 19:
            (a.getLogger().trace("Node: ", r[d].id),
              a.addNode(0, r[d].id, r[d].descr, r[d].type));
            break;
          case 20:
            a.decorateNode({ icon: r[d] });
            break;
          case 25:
            (a.getLogger().trace("node found ..", r[d - 2]),
              (this.$ = {
                id: r[d - 1],
                descr: r[d - 1],
                type: a.getType(r[d - 2], r[d]),
              }));
            break;
          case 26:
            ...
            break;
          case 27:
            (a.getLogger().trace("node found ..", r[d - 3]),
              (this.$ = {
                id: r[d - 3],
                descr: r[d - 1],
                type: a.getType(r[d - 2], r[d]),
        ...
        for (var _, T, D, H, O = {}, P, k, ie, M; ;) {
          if (
            ...
            this.defaultActions[T]
              ? (D = this.defaultActions[T])
              : ((_ === null || typeof _ > "u") && (_ = te()),
                (D = w[T] && w[T][_])),
          ...
          switch (D[0]) {
            ...
            case 2:
              if (
                ...
                (H = this.performAction.apply(
                  O,
                  [d, Z, U, v.yy, D[1], g, r].concat(oe),
                )),
                typeof H < "u")
              )
                return H;
              (k &&
                ...
                g.push(O.$),
                r.push(O._$),
                (ie = w[o[o.length - 2]][o[o.length - 1]]),
                o.push(ie));
              break;
            case 3:
              return !0;
        ...
        unput: l(function (s) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: o
                ? (o.length === a.length ? this.yylloc.first_column : 0) +
                  a[a.length - o.length].length -
                  o[0].length
                : this.yylloc.first_column - i,
            }),
            this.options.ranges &&
              (this.yylloc.range = [g[0], g[0] + this.yyleng - i]),
...
` +
        ...
        next: l(function () {
          ...
          for (var g = this._currentRules(), r = 0; r < g.length; r++)
            if (
              ((o = this._input.match(this.rules[g[r]])),
              o && (!i || o[0].length > i[0].length))
            ) {
              if (((i = o), (a = r), this.options.backtrack_lexer)) {
                if (((s = this.test_match(o, g[r])), s !== !1)) return s;
                if (this._backtrack) {
                  i = !1;
                  continue;
                } else return !1;
          ...
          return i
            ? ((s = this.test_match(i, g[a])), s !== !1 ? s : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: l(function (i, o, a, g) {
          switch (a) {
            case 0:
            ...
            case 10:
              return (
                i.getLogger().trace("Exploding node"),
                this.begin("NODE"),
                19
              );
            case 11:
            ...
            case 12:
              return (
                i.getLogger().trace("Explosion Bang"),
                this.begin("NODE"),
                19
              );
            case 13:
              return (
                i.getLogger().trace("Cloud Bang"),
                this.begin("NODE"),
                19
              );
            case 14:
            ...
            case 25:
              return (
                i.getLogger().trace("description:", o.yytext),
                "NODE_DESCR"
              );
            case 26:
              this.popState();
            ...
            case 29:
              return (
                this.popState(),
                i.getLogger().trace("node end ...", o.yytext),
                "NODE_DEND"
              );
            case 30:
              return (
    ...
    ((C = class {
      ...
      getParent(e) {
        for (let n = this.nodes.length - 1; n >= 0; n--)
          if (this.nodes[n].level < e) return this.nodes[n];
        return null;
      }
      getMindmap() {
      ...
      decorateNode(e) {
        ...
        (e.icon && (c.icon = V(e.icon, n)),
          e.class && (c.class = V(e.class, n)));
      }
      type2Str(e) {
        switch (e) {
      ...
      assignSections(e, n) {
        if (
          (e.level === 0 ? (e.section = void 0) : (e.section = n), e.children)
        )
      ...
      flattenNodes(e, n) {
        ...
        if ((n.push(p), e.children))
          for (const m of e.children) this.flattenNodes(m, n);
      }
      generateEdges(e, n) {
        if (e.children)
