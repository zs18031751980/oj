import { p as Y } from "./chunk-4BX2VUAB-CeCflfTV.js";
import { I as K } from "./chunk-QZHKN3VN-gKq55Nkv.js";
import {
  _ as l,
  t as U,
  q as V,
...
import { p as dr } from "./treemap-KMMF4GRG-BMiVl7UM.js";
...
var lr = l(function (t) {
  ...
  yr = l(function (t) {
    ...
    (c.records.branches.set(
      r,
      c.records.head != null ? c.records.head.id : null,
    ),
...
function P(t) {
  ...
  if (
    (m.debug(n.join(" ")),
    r.parents && r.parents.length == 2 && r.parents[0] && r.parents[1])
  ) {
...
var xr = l(function () {
  ...
  br = l(function () {
    return [...c.records.branchConfig.values()]
      .map((r, s) =>
        r.order !== null && r.order !== void 0
          ? r
          : { ...r, order: parseFloat(`0.${s}`) },
      )
  ...
  _r = l((t, r, s) => {
    ...
    (t.forEach((d) => {
      ...
      (o.parents.length ? ((n = zr(o)), (e = Math.max(n, e))) : a.push(o),
        Fr(o, n));
    }),
      (n = e),
      a.forEach((d) => {
    ...
    if (r.tags.length > 0) {
      ...
      ${s.posWithOffset - a / 2 - E},${y + i + T}`,
        ...
        ${s.x + L},${p + i + 2}`,
            ...
            .attr(
              "transform",
              "translate(12,12) rotate(45, " + s.x + "," + n + ")",
            ),
            h
              .attr("cx", s.x + E / 2)
              .attr("cy", p)
            ...
            f
              ...
              .attr(
                "transform",
                "translate(14,14) rotate(45, " + s.x + "," + n + ")",
              ));
        }
      }
    }
  ...
  Ur = l((t, r, s, n, e) => {
    const d = (u === "TB" || u === "BT" ? s.x < n.x : s.y < n.y)
        ? r.branch
        : t.branch,
  ...
  Vr = l((t, r, s, n) => {
    ...
    if (e === void 0 || a === void 0)
      throw new Error(
        `Commit positions not found for commits ${r.id} and ${s.id}`,
      );
        ...
        u === "TB"
          ...
          : u === "BT"
            ? ($.attr("x", d - y.width / 2 - 10).attr("y", B),
              i.attr(
                "transform",
                "translate(" + (d - y.width / 2 - 5) + ", " + B + ")",
              ))
            : $.attr(
                "transform",
                "translate(-19, " + (d - y.height / 2) + ")",
              ));
    });
  }, "drawBranches"),
