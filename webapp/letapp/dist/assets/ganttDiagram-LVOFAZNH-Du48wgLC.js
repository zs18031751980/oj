...
import { g as we } from "./vendor-markdown-HlADSkmp.js";
import {
  b as Zn,
  t as Oe,
  c as Xn,
  a as Gn,
  l as $n,
} from "./linear-BeNOPYj5.js";
import { i as Qn } from "./init-Gi6I4Gst.js";
...
function on(t, e) {
  ...
  function C(x) {
    var X = r ?? (e.ticks ? e.ticks.apply(e, n) : e.domain()),
      O = a ?? (e.tickFormat ? e.tickFormat.apply(e, n) : Kn),
      M = Math.max(i, 0) + y,
      I = e.range(),
      V = +I[0] + _,
      W = +I[I.length - 1] + _,
      B = (e.bandwidth ? rr : nr)(e.copy(), _),
      Q = x.selection ? x.selection() : x,
      D = Q.selectAll(".domain").data([null]),
      H = Q.selectAll(".tick").data(X, e).order(),
      b = H.exit(),
      Y = H.enter().append("g").attr("class", "tick"),
      F = H.select("line"),
      S = H.select("text");
    ((D = D.merge(
      D.enter()
      ...
      D.attr(
        ...
        t === Zt || t === oe
          ? s
            ? "M" + p * s + "," + V + "H" + _ + "V" + W + "H" + p * s
            : "M" + _ + "," + V + "V" + W
          : s
            ? "M" + V + "," + p * s + "V" + _ + "H" + W + "V" + p * s
            : "M" + V + "," + _ + "H" + W,
      ),
      H.attr("opacity", 1).attr("transform", function (v) {
        return E(B(v) + _);
      }),
      F.attr(g + "2", p * i),
      S.attr(g, p * M).text(O),
  ...
  return (
    ...
    (C.tickArguments = function (x) {
      return arguments.length
        ? ((n = x == null ? [] : Array.from(x)), C)
        : n.slice();
    }),
    (C.tickValues = function (x) {
      return arguments.length
        ? ((r = x == null ? null : Array.from(x)), C)
        : r && r.slice();
    }),
...
function dn(t) {
  ...
  var e = fe(t.r),
    n = fe(t.g),
    r = fe(t.b),
    a = ce((0.2225045 * e + 0.7168786 * n + 0.0606169 * r) / un),
    i,
    s;
  return (
    e === n && n === r
      ? (i = s = a)
      : ((i = ce((0.4360747 * e + 0.3850649 * n + 0.1430804 * r) / cn)),
        (s = ce((0.0139322 * e + 0.0971045 * n + 0.7141733 * r) / ln))),
    new ft(116 * a - 16, 500 * (i - a), 200 * (a - s), t.opacity)
  );
}
function lr(t, e, n, r) {
...
function et(t, e, n, r) {
  ...
  return (
    (a.floor = (i) => (t((i = new Date(+i))), i)),
    (a.ceil = (i) => (t((i = new Date(i - 1))), e(i, 1), t(i), i)),
    (a.round = (i) => {
      const s = a(i),
        y = a.ceil(i);
      return i - s < y - i ? s : y;
    ...
    (a.range = (i, s, y) => {
      ...
      if (
        ...
        return _;
      let p;
      do (_.push((p = new Date(+i))), e(i, y), t(i));
      while (p < i && i < s);
      return _;
    }),
    (a.filter = (i) =>
...
function wt(t) {
  return et(
    ...
    (e, n) =>
      (n - e - (n.getTimezoneOffset() - e.getTimezoneOffset()) * ct) / De,
  );
}
const Vt = wt(0),
  Ht = wt(1),
  ...
  function D(k, A) {
    return function (N) {
      var f = [],
        ...
        rt,
        st;
      for (N instanceof Date || (N = new Date(+N)); ++J < $;)
        k.charCodeAt(J) === 37 &&
          (f.push(k.slice(L, J)),
          (rt = Ve[(Z = k.charAt(++J))]) != null
            ? (Z = k.charAt(++J))
            : (rt = Z === "e" ? " " : "0"),
          (st = A[Z]) && (Z = st(N, rt)),
          f.push(Z),
...
function Fa() {
  return Qn.apply(
    Dn(Dr, Cr, kt, Nt, Vt, Tt, Ot, Wt, vt, ne).domain([
      new Date(2e3, 0, 1),
      new Date(2e3, 0, 2),
    ]),
    arguments,
          ...
          return function (r, a, i) {
            ...
            ((y.isoWeekYear = function () {
              ...
              (y.isoWeekday = function (p) {
                return this.$utils().u(p)
                  ? this.day() || 7
                  : this.day(this.day() % 7 ? p : p - 7);
              }));
            var _ = y.startOf;
            y.startOf = function (p, g) {
              var E = this.$utils(),
                C = !!E.u(g) || g;
              return E.p(p) === "isoweek"
                ? C
        ...
        (function (n, r) {
          ...
          return function (M, I, V) {
            ((V.p.customParseFormat = !0),
              M && M.parseTwoDigitYear && (p = M.parseTwoDigitYear));
            var W = I.prototype,
              B = W.parse;
            W.parse = function (Q) {
              var D = Q.date,
              ...
              if (typeof Y == "string") {
                ...
                (S && (U = b[2]),
                  ...
                  v && D != this.format(Y) && (this.$d = new Date("")),
                  (_ = {}));
              } else if (Y instanceof Array)
                for (var l = Y.length, m = 1; m <= l; m += 1) {
                  b[1] = Y[m - 1];
...
var ve = (function () {
  var t = h(function (U, l, m, T) {
    ...
    F = {
      ...
      performAction: h(function (l, m, T, d, w, c, u) {
        var o = c.length - 1;
        switch (w) {
          case 1:
            return c[o - 1];
        ...
        unput: h(function (l) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: T
                ? (T.length === d.length ? this.yylloc.first_column : 0) +
                  d[d.length - T.length].length -
                  T[0].length
        ...
        next: h(function () {
          ...
          for (var w = this._currentRules(), c = 0; c < w.length; c++)
            if (
              ...
              T && (!m || T[0].length > m[0].length))
            ) {
              if (((m = T), (d = c), this.options.backtrack_lexer)) {
                if (((l = this.test_match(T, w[c])), l !== !1)) return l;
                if (this._backtrack) {
                  m = !1;
                  continue;
                } else return !1;
          ...
          return m
            ? ((l = this.test_match(m, w[d])), l !== !1 ? l : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: h(function (m, T, d, w) {
          switch (d) {
            case 0:
...
var Ke = { friday: 5, saturday: 6 },
  ...
  Et = "",
  Ue = "",
  Cn = ["active", "done", "crit", "milestone", "vert"],
  Ee = [],
  Rt = !1,
  Le = !1,
  Ae = "sunday",
  ...
  Mn = h(function (t, e, n, r) {
    const a = t.format(e.trim()),
      i = t.format("YYYY-MM-DD");
    return r.includes(a) || r.includes(i)
      ? !1
      : (n.includes("weekends") &&
            (t.isoWeekday() === Ke[ae] || t.isoWeekday() === Ke[ae] + 1)) ||
          n.includes(t.format("dddd").toLowerCase())
        ? !0
        : n.includes(a) || n.includes(i);
  }, "isInvalidDate"),
  hi = h(function (t) {
    Ae = t;
  }, "setWeekday"),
  ...
  yi = h(function (t, e) {
    ...
    return (
      i &&
        ...
        (a.manualEndTime = at(i, "YYYY-MM-DD", !0).isValid()),
        _n(a, lt, zt, Pt)),
      a
    );
  }, "compileData"),
  ...
  Di = {
    getConfig: h(() => _t().gantt, "getConfig"),
    clear: Ra,
    setDateFormat: Qa,
    getDateFormat: ri,
...
var Ci = h(function () {
  ...
  Mi = h((t, e) => {
    let n = [...t].map(() => -1 / 0),
      r = [...t].sort((i, s) => i.startTime - s.startTime || i.order - s.order),
      a = 0;
    for (const i of r)
  ...
  ht,
  _i = h(function (t, e, n, r) {
    const a = _t().gantt,
      i = _t().securityLevel;
    let s;
    i === "sandbox" && (s = Bt("#i" + e));
    const y =
        i === "sandbox" ? Bt(s.nodes()[0].contentDocument.body) : Bt("body"),
      _ = i === "sandbox" ? s.nodes()[0].contentDocument : document,
      p = _.getElementById(e);
    ((ht = p.parentElement.offsetWidth),
      ht === void 0 && (ht = 1200),
      a.useWidth !== void 0 && (ht = a.useWidth));
    const g = r.db.getTasks();
    let E = [];
    for (const b of g) E.push(b.type);
    E = H(E);
    const C = {};
    ...
    if (r.db.getDisplayMode() === "compact" || a.displayMode === "compact") {
      ...
      for (const b of E) C[b] = g.filter((Y) => Y.type === b).length;
    }
    ...
    function V(b, Y, F, S, v, U, l) {
      ...
      const T = [...new Set(b.map((u) => u.order))].map((u) =>
        b.find((o) => o.order === u),
      );
      X.append("g")
        .selectAll("rect")
      ...
      if (
        (d
          ...
          .attr("width", function (u) {
            return u.milestone
              ...
              : u.vert
                ? 0.08 * v
                : O(u.renderEndTime || u.endTime) - O(u.startTime);
          })
          .attr("height", function (u) {
            return u.vert
              ? g.length * (a.barHeight + a.barGap) + a.barHeight * 2
              : v;
          })
        ...
        d
          ...
          .attr("x", function (u) {
            let o = O(u.startTime),
              z = O(u.renderEndTime || u.endTime);
            if (
              (u.milestone &&
                ((o += 0.5 * (O(u.endTime) - O(u.startTime)) - 0.5 * v),
                (z = o + v)),
              u.vert)
            )
          ...
          .attr("y", function (u, o) {
            return u.vert
              ? a.gridLineStartPadding +
                  g.length * (a.barHeight + a.barGap) +
                  60
              : ((o = u.order),
                o * Y + a.barHeight / 2 + (a.fontSize / 2 - 2) + F);
          })
          .attr("text-height", v)
          .attr("class", function (u) {
            ...
            return (
              ...
              P > z - o
                ? z + P + 1.5 * a.leftPadding > l
                  ? R + " taskTextOutsideLeft taskTextOutside" + K + " " + G
                  : R +
                    ...
                    " width-" +
                    P
                : R + " taskText taskText" + K + " " + G + " width-" + P
            );
          }),
        ...
        d.filter(function (z) {
          ...
          var P = o.querySelector("#" + z.id),
            R = o.querySelector("#" + z.id + "-text");
    ...
    function W(b, Y, F, S, v, U, l, m) {
      ...
      X.append("g")
        ...
        .enter()
        .append("rect")
        .attr("id", (P) => "exclude-" + P.start.format("YYYY-MM-DD"))
        .attr("x", (P) => O(P.start.startOf("day")) + F)
        .attr("y", a.gridLineStartPadding)
        .attr("width", (P) => O(P.end.endOf("day")) - O(P.start.startOf("day")))
        .attr("height", v - Y - a.gridLineStartPadding)
        .attr("transform-origin", function (P, R) {
          return (
            (O(P.start) + F + 0.5 * (O(P.end) - O(P.start))).toString() +
            "px " +
            (R * b + 0.5 * v).toString() +
            "px"
          );
    ...
    function B(b, Y, F, S) {
      ...
      let m = sr(O)
        .tickSize(-S + Y + a.gridLineStartPadding)
        .tickFormat(ne(l));
      const d =
      ...
      if (
        (X.append("g")
          .attr("class", "grid")
          .attr("transform", "translate(" + b + ", " + (S - 50) + ")")
          .call(m)
          .selectAll("text")
      ...
      X.append("g")
        ...
        .append(function (v) {
          const U = v[0].split(zn.lineBreakRegex),
            l = -(U.length - 1) / 2,
            m = _.createElementNS("http://www.w3.org/2000/svg", "text");
    ...
    function H(b) {
      ...
      for (let S = 0, v = b.length; S < v; ++S)
        Object.prototype.hasOwnProperty.call(Y, b[S]) ||
          ((Y[b[S]] = !0), F.push(b[S]));
      return F;
    }
    h(H, "checkUnique");
  }, "draw"),
  Si = { setConf: Ci, draw: _i },
  Fi = h(
    (t) => `
  .mermaid-main-font {
...
`,
  ...
  Yi = Fi,
  zi = { parser: za, db: Di, renderer: Si, styles: Yi };
