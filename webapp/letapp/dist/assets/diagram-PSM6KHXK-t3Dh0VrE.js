...
import { s as we } from "./chunk-QN33PNHL-Bp-R7uq3.js";
import { p as Ce } from "./chunk-4BX2VUAB-CeCflfTV.js";
import { p as Te } from "./treemap-KMMF4GRG-BMiVl7UM.js";
...
function Ne(t, a) {
  for (var l = this, n = [l], o = [], s, d, h, m = -1; (l = n.pop());)
    if ((o.push(l), (s = l.children)))
      for (d = 0, h = s.length; d < h; ++d) n.push(s[d]);
  ...
  do
    for (a = l.reverse(), l = []; (t = a.pop());)
      if ((yield t, (n = t.children)))
        for (o = 0, s = n.length; o < s; ++o) l.push(n[o]);
  while (l.length);
}
function Q(t, a) {
  t instanceof Map
    ? ((t = [void 0, t]), a === void 0 && (a = Ie))
    : a === void 0 && (a = He);
  for (var l = new K(t), n, o = [l], s, d, h, m; (n = o.pop());)
    if ((d = a(n.data)) && (m = (d = Array.from(d)).length))
      for (n.children = d, h = m - 1; h >= 0; --h)
        (o.push((s = d[h] = new K(d[h]))),
          (s.parent = n),
          (s.depth = n.depth + 1));
...
function Ue(t, a, l, n, o, s) {
  for (
    ...
    (d.push((m = { value: u, dice: x < S, children: h.slice(p, b) })),
      m.dice
        ? je(m, l, n, o, v ? (n += (S * u) / v) : s)
        : Ye(m, l, n, v ? (l += (x * u) / v) : o, s),
      (v -= u),
      (p = b));
  }
  return d;
...
function Je() {
  ...
  return (
    ...
    (p.size = function (r) {
      return arguments.length ? ((l = +r[0]), (n = +r[1]), p) : [l, n];
    }),
    (p.tile = function (r) {
      return arguments.length ? ((t = qe(r)), p) : t;
    }),
    (p.padding = function (r) {
      return arguments.length
        ? p.paddingInner(r).paddingOuter(r)
        : p.paddingInner();
    }),
    (p.paddingInner = function (r) {
      return arguments.length
        ? ((s = typeof r == "function" ? r : q(+r)), p)
        : s;
    }),
    ...
    (p.paddingTop = function (r) {
      return arguments.length
        ? ((d = typeof r == "function" ? r : q(+r)), p)
        : d;
    }),
    (p.paddingRight = function (r) {
      return arguments.length
        ? ((h = typeof r == "function" ? r : q(+r)), p)
        : h;
    }),
    (p.paddingBottom = function (r) {
      return arguments.length
        ? ((m = typeof r == "function" ? r : q(+r)), p)
        : m;
    }),
    (p.paddingLeft = function (r) {
      return arguments.length
        ? ((c = typeof r == "function" ? r : q(+r)), p)
        : c;
    }),
    p
  );
  ...
  ne =
    ((R = class {
      ...
      addNode(a, l) {
        (this.nodes.push(a),
          this.levels.set(a, l),
          l === 0 && (this.outerNodes.push(a), this.root ?? (this.root = a)));
      }
      getRoot() {
...
var Qe = w((t, a) => {
    ...
    const n = le(l),
      o = w((s, d) => {
        for (const h of s)
          (a.addNode(h, d),
            h.children && h.children.length > 0 && o(h.children, d + 1));
      }, "addNodesRecursively");
    o(n, 0);
  }, "populate"),
  ...
  at = w((t, a, l, n) => {
    ...
    (j
      ...
      .attr(
        "style",
        (e) => P({ cssCompiledStyles: e.data.cssCompiledStyles }).nodeStyles,
      )
      .attr("fill-opacity", 0.3)
      .attr("stroke", (e) =>
        e.parent ? g(e.parent.data.name) : g(e.data.name),
      )
      .attr("stroke-width", 3),
      j
        .append("clipPath")
      ...
      j
        ...
        .each(function (e) {
          ...
          for (
            ...
            y > _ &&
            (y--,
            (I = Math.max(z, Math.min(F, Math.round(y * T)))),
            !(I < z && y === _));
          )
            (i.style("font-size", `${y}px`), (U = y + H + I));
          (i.style("font-size", `${y}px`),
            (L.getComputedTextLength() > D || y < _ || A < y) &&
              i.style("display", "none"));
        }),
      s.showValues !== !1 &&
        j
