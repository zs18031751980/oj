...
import { p as _ } from "./chunk-4BX2VUAB-CeCflfTV.js";
import { p as N } from "./treemap-KMMF4GRG-BMiVl7UM.js";
  ...
  Y = b((e, t) => {
    ...
    for (let { start: a, end: i, bits: d, label: c } of e.blocks) {
      if (a !== void 0 && i !== void 0 && i < a)
        throw new Error(
          `Packet block ${a} - ${i} is invalid. End must be greater than start.`,
        );
      if ((a ?? (a = r + 1), a !== r + 1))
        throw new Error(
      ...
      for (
        ...
        if (
          (o.push(p), p.end + 1 === n * l && (t.pushWord(o), (o = []), n++), !s)
        )
          break;
