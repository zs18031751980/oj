...
function Bt() {
  ...
  ((v.update = function (n) {
    ...
    (v.nodeId = function (n) {
      return arguments.length
        ? ((k = typeof n == "function" ? n : X(n)), v)
        : k;
    }),
    (v.nodeAlign = function (n) {
      return arguments.length
        ? ((s = typeof n == "function" ? n : X(n)), v)
        : s;
    }),
    ...
    (v.nodes = function (n) {
      return arguments.length
        ? ((_ = typeof n == "function" ? n : X(n)), v)
        : _;
    }),
    (v.links = function (n) {
      return arguments.length
        ? ((x = typeof n == "function" ? n : X(n)), v)
        : x;
    }),
  ...
  function M({ nodes: n, links: f }) {
    ...
    for (const [c, r] of f.entries()) {
      ...
      (typeof m != "object" && (m = r.source = ft(u, m)),
        typeof w != "object" && (w = r.target = ft(u, w)),
        m.sourceLinks.push(r),
  ...
  function R(n) {
    ...
    for (const u of n) {
      let c = e;
      for (const r of u) {
        ((r.y0 = c), (r.y1 = c + r.value * f), (c = r.y1 + g));
...
ot.prototype = kt.prototype = {
    ...
    if (this._x1 === null)
      ...
      if (!(Math.abs(l * k - s * o) > V) || !h)
        ...
        var x = i - b,
          ...
          T = Math.sqrt(v),
          N = Math.sqrt(_),
          C = h * Math.tan((st - Math.acos((v + _ - M) / (2 * T * N))) / 2),
          D = C / N,
          R = C / T;
        (Math.abs(D - 1) > V &&
  ...
  arc: function (t, e, i, a, h, b) {
    ...
    (this._x1 === null
      ? (this._ += "M" + s + "," + o)
      : (Math.abs(this._x1 - s) > V || Math.abs(this._y1 - o) > V) &&
        (this._ += "L" + s + "," + o),
      i &&
        (_ < 0 && (_ = (_ % rt) + rt),
        _ > Rt
...
function Yt(t) {
  ...
  return (
    ...
    (g.x = function (k) {
      return arguments.length
        ? ((a = typeof k == "function" ? k : dt(+k)), g)
        : a;
    }),
    (g.y = function (k) {
      return arguments.length
        ? ((h = typeof k == "function" ? k : dt(+k)), g)
        : h;
    }),
...
var at = (function () {
  var t = p(function (k, s, o, l) {
    ...
    h = {
      ...
      performAction: p(function (s, o, l, _, x, y, v) {
        var M = y.length - 1;
        switch (x) {
          case 7:
...
` +
        ...
        next: p(function () {
          ...
          for (var x = this._currentRules(), y = 0; y < x.length; y++)
            if (
              ...
              if (((o = l), (_ = y), this.options.backtrack_lexer)) {
                if (((s = this.test_match(l, x[y])), s !== !1)) return s;
                if (this._backtrack) {
                  o = !1;
                  continue;
                } else return !1;
          ...
          return o
            ? ((s = this.test_match(o, x[_])), s !== !1 ? s : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
var K = at,
  ...
  le = p(function (t, e, i, a) {
    ...
    h === "sandbox" && (k = H("#i" + e));
    const s =
        h === "sandbox" ? H(k.nodes()[0].contentDocument.body) : H("body"),
...
`,
  ...
  ye = K.parse.bind(K);
K.parse = (t) => ye(ue(t));
var Se = { styles: fe, parser: K, db: oe, renderer: ce };
