...
import { G as B } from "./graph-DGE5ET1D.js";
import { l as I } from "./layout-DFMOLej3.js";
import { b, e as L, m as A } from "./vendor-naive-Co-etydz.js";
...
var d = new Map(),
      ...
      r.forEach((o) => {
        if (t.children(o).length > 0) G(o, t, n, a);
          ...
          (i.info("cp ", o, " to ", a, " with parent ", e),
            n.setNode(o, l),
            a !== t.parent(o) &&
              (i.warn("Setting parent", o, t.parent(o)),
  ...
  k = w(
    (e) =>
      !d.has(e) || !d.get(e).externalConnections
        ? e
        : d.has(e)
          ? d.get(e).id
          : e,
  ...
  re = w((e, t) => {
    ...
    (e.edges().forEach(function (n) {
      ...
      if (
        ...
        (i.warn("Fix Replacing with XXX", r, o, n.name),
          e.setEdge(r, o, a, n.name));
      }
    }),
    ...
    for (const r of n)
      if (
        ...
        d.get(r)?.clusterData?.dir &&
          ((l = d.get(r).clusterData.dir),
          i.warn("Fixing dir", d.get(r).clusterData.dir, l));
...
Parent cluster`,
            ...
            t.setNode(r.id, g),
            t.parent(f) ||
              (i.trace("Setting parent", f, r.id), t.setParent(f, r.id, g)));
        }
        if (
          (i.info("(Insert) Node XXX" + f + ": " + JSON.stringify(t.node(f))),
          s?.clusterNode)
        ) {
          ...
          t.children(f).length > 0
            ...
            : (i.trace("Node - the non recursive path XAX", f, p, t.node(f), l),
              await $(p, t.node(f), { config: o, dir: l }));
      }),
    ),
      await w(async () => {
