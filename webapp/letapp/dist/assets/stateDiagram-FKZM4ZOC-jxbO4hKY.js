import { s as R, a as W, S as N } from "./chunk-DI55MBZ5-D6OT_UNa.js";
import {
  _ as f,
  c as t,
  d as H,
...
import { G as O } from "./graph-DGE5ET1D.js";
import { l as J } from "./layout-DFMOLej3.js";
import "./chunk-55IACEB6-DFsD1jDV.js";
import "./chunk-QN33PNHL-Bp-R7uq3.js";
...
var X = f(
    ...
    if (
      ...
      for (let u = 0; u <= o.length; u++) {
        ...
        ((m = Math.max(m, y.width)),
          ...
          S.info(y.x, w, p + g),
          g === 0 &&
            ((g = h.node().getBBox().height), S.info("Title height", g, p)),
          B.push(h));
      }
      let k = g * o.length;
      if (o.length > 1) {
  ...
  et = f(function (e, i, d, c) {
    ...
    n === "sandbox" && (l = H("#i" + i));
    const x =
        n === "sandbox" ? H(l.nodes()[0].contentDocument.body) : H("body"),
  ...
  G = f((e, i, d, c, n, l, x) => {
    ...
    a.nodes().forEach(function (r) {
      r !== void 0 && a.node(r) !== void 0
        ? (S.warn("Node " + r + ": " + JSON.stringify(a.node(r))),
          ...
          n
            .select("#" + m.id + " #" + r)
            .attr("data-x-shift", a.node(r).x - a.node(r).width / 2),
          l
            .querySelectorAll("#" + m.id + " #" + r + " .divider")
            .forEach((h) => {
    ...
    (a.edges().forEach(function (r) {
      r !== void 0 &&
        a.edge(r) !== void 0 &&
        (S.debug(
          "Edge " + r.v + " -> " + r.w + ": " + JSON.stringify(a.edge(r)),
        ),
