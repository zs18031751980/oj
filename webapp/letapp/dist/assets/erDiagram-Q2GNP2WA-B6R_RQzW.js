import { g as Dt } from "./chunk-55IACEB6-DFsD1jDV.js";
import { s as wt } from "./chunk-QN33PNHL-Bp-R7uq3.js";
import {
  _ as u,
  b as Vt,
  a as Lt,
...
import { c as Qt } from "./channel-CXGY4jjC.js";
    ...
    ct = {
      ...
      parse: u(function (n) {
        ...
        for (var ot in this.yy)
          Object.prototype.hasOwnProperty.call(this.yy, ot) &&
            (I.yy[ot] = this.yy[ot]);
        (f.setInput(n, I.yy),
          (I.yy.lexer = f),
          (I.yy.parser = this),
...
var Xt = dt,
    ...
    ((w = class {
        ...
        return (
          this.entities.has(i)
            ? !this.entities.get(i)?.alias &&
              o &&
              ((this.entities.get(i).alias = o),
              D.info(`Add alias '${o}' to entity '${i}'`))
            : (this.entities.set(i, {
      ...
      addAttributes(i, o) {
        ...
        for (l = o.length - 1; l >= 0; l--)
          (o[l].keys || (o[l].keys = []),
            o[l].comment || (o[l].comment = ""),
            d.attributes.push(o[l]),
            D.debug("Added attribute ", o[l].name));
      }
      addRelationship(i, o, d, l) {
        const h = this.entities.get(i),
          y = this.entities.get(d);
        if (!h || !y) return;
        const _ = { entityA: h.id, roleA: o, entityB: y.id, relSpec: l };
      ...
      getCompiledStyles(i) {
        ...
        for (const d of i) {
          ...
          (l?.styles && (o = [...o, ...(l.styles ?? [])].map((h) => h.trim())),
            l?.textStyles &&
              (o = [...o, ...(l.textStyles ?? [])].map((h) => h.trim())));
        }
        return o;
      }
      addCssStyles(i, o) {
        for (const d of i) {
          ...
          if (!o || !l) return;
          for (const h of o) l.cssStyles.push(h);
        }
      }
      addClass(i, o) {
        i.forEach((d) => {
          ...
          (l === void 0 &&
            ((l = { id: d, styles: [], textStyles: [] }),
            this.classes.set(d, l)),
            o &&
      ...
      setClass(i, o) {
        for (const d of i) {
          const l = this.entities.get(d);
          if (l) for (const h of o) l.cssClasses += " " + h;
        }
      }
      clear() {
        ((this.entities = new Map()),
      ...
      getData() {
        ...
        for (const h of this.entities.keys()) {
          ...
          y &&
            ((y.cssCompiledStyles = this.getCompiledStyles(
              y.cssClasses.split(" "),
            )),
            i.push(y));
        }
        ...
        for (const h of this.relationships) {
          const y = {
            id: zt(h.entityA, h.entityB, { prefix: "id", counter: l++ }),
            type: "normal",
            curve: "basis",
            start: h.entityA,
            end: h.entityB,
        ...
        return { nodes: i, edges: o, other: {}, config: d, direction: "TB" };
      }
    }),
    u(w, "ErDB"),
    w),
  Nt = {};
Kt(Nt, { draw: () => Ht });
var Ht = u(async function (s, i, o, d) {
    (D.info("REF0:"), D.info("Drawing er diagram (unified)", i));
    const { securityLevel: l, er: h, layout: y } = tt(),
      _ = d.db.getData(),
      E = Dt(i, l);
    ((_.type = d.type),
      (_.layoutAlgorithm = Zt(y)),
