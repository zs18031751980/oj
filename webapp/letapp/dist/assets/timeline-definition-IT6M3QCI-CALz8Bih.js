...
import { d as nt } from "./arc-DG_fivhK.js";
    ...
    p = {
      ...
      parse: s(function (r) {
        ...
        for (var L in this.yy)
          Object.prototype.hasOwnProperty.call(this.yy, L) &&
            (b.yy[L] = this.yy[L]);
        (g.setInput(r, b.yy),
          (b.yy.lexer = g),
          (b.yy.parser = this),
        ...
        s(tt, "lex");
        for (var S, A, I, J, R = {}, B, $, et, O; ;) {
          if (
            ((A = c[c.length - 1]),
            this.defaultActions[A]
              ? (I = this.defaultActions[A])
              : ((S === null || typeof S > "u") && (S = tt()),
                (I = w[A] && w[A][S])),
...
var z = "",
  ...
  Lt = s(function (n, t) {
    ...
    return (
      s(f, "ambivalent"),
      t.score > 3 ? d(i) : t.score < 3 ? h(i) : f(i),
      l
    );
  }, "drawFace"),
  Mt = s(function (n, t) {
...
var zt = s(function (n, t, e, l) {
  ...
  Wt = s(function (n, t, e, l) {
    ...
    h === "sandbox" && (f = j("#i" + t));
    const p = (
      h === "sandbox" ? j(f.nodes()[0].contentDocument.body) : j("body")
    ).select("#" + t);
    p.append("g");
    ...
    for (const [H, g] of k.entries()) {
      ...
      for (const W of g.events) {
        ...
        M += C.getVirtualNodeHeight(p, Z, i);
      }
      (g.events.length > 0 && (M += (g.events.length - 1) * 10),
        (P = Math.max(P, M)));
    }
    (E.debug("maxSectionHeight before draw", r),
      ...
      x && x.length > 0
        ? x.forEach((H) => {
            ...
            const L = p.append("g"),
              M = C.drawNode(L, b, w, i);
            (E.debug("sectionNode output", M),
...
`,
  ...
  qt = Gt,
  ee = { db: at, renderer: Ot, parser: Tt, styles: qt };
