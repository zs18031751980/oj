...
<template>
  <div class="min-h-screen bg-slate-50 text-slate-950 dark:bg-slate-950 dark:text-slate-50">
    ...
    <div class="flex">
      <aside
        class="fixed bottom-0 top-16 z-40 overflow-y-auto border-r border-slate-200/30 bg-transparent backdrop-blur-2xl transition-all duration-300 dark:border-slate-800/20"
